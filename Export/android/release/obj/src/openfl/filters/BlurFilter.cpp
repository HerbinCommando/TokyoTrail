...
HXDLIN(  36)		return  ::openfl::filters::BlurFilter_obj::__alloc( HX_CTX ,this->blurX,this->blurY,this->quality);
            	}
...
HXDLIN(  13)		_hx___blurShader =  ::openfl::filters::_BlurFilter::BlurShader_obj::__alloc( HX_CTX );
            	}
}
