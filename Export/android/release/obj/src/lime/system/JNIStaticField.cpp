...
HX_LOCAL_STACK_FRAME(_hx_pos_241b089bf20ccbef_263_get,"lime.system.JNIStaticField","get",0x7995bc55,"lime.system.JNIStaticField.get","lime/system/JNI.hx",263,0x21970b7f)
HX_LOCAL_STACK_FRAME(_hx_pos_241b089bf20ccbef_271_set,"lime.system.JNIStaticField","set",0x799ed761,"lime.system.JNIStaticField.set","lime/system/JNI.hx",271,0x21970b7f)
namespace lime{
...
bool JNIStaticField_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic JNIStaticField_obj::get(){
            	HX_STACKFRAME(&_hx_pos_241b089bf20ccbef_263_get)
HXDLIN( 263)		return ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_jni_get_static(hx::DynamicPtr(this->field))) );
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(JNIStaticField_obj,get,return )
 ...
 ::Dynamic JNIStaticField_obj::set( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_241b089bf20ccbef_271_set)
HXLINE( 274)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_jni_set_static(hx::DynamicPtr(this->field),hx::DynamicPtr(value));
