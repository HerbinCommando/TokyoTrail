...
HXDLIN(  47)		return  ::openfl::filters::GlowFilter_obj::__alloc( HX_CTX ,this->color,this->alpha,this->blurX,this->blurY,this->strength,this->quality,this->inner,this->knockout);
            	}
...
HXDLIN(  89)		return (this->knockout = value);
            	}
...
HXDLIN(  12)		_hx___glowShader =  ::openfl::filters::_GlowFilter::GlowShader_obj::__alloc( HX_CTX );
            	}
}
