...
HXDLIN(  54)		if (hx::IsNotNull( this->_hx___buffer )) {
...
HXDLIN(  79)		 ::openfl::media::Sound _gthis = hx::ObjectPtr<OBJ_>(this);
...
HXDLIN( 210)		return  ::openfl::media::ID3Info_obj::__alloc( HX_CTX );
            	}
...
HXDLIN( 246)		if (hx::IsNull( buffer )) {
...
HXDLIN(  74)		return ::openfl::media::Sound_obj::fromAudioBuffer(::lime::media::AudioBuffer_obj::fromFile(path));
            	}
