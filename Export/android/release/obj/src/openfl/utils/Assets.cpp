...
HXLINE(  93)			_hx_tmp1 = ::openfl::utils::IAssetCache_obj::get_enabled(::openfl::utils::Assets_obj::cache);
            		}
            		else {
...
HXLINE( 115)				_hx_tmp2 = ::openfl::utils::IAssetCache_obj::get_enabled(::openfl::utils::Assets_obj::cache);
            			}
            			else {
...
HXDLIN( 860)		::lime::utils::Assets_obj::registerLibrary(name,library);
            	}
...
HXDLIN( 867)		::openfl::utils::Assets_obj::dispatcher->removeEventListener(type,listener,capture);
            	}
...
HXDLIN( 874)		return ::Type_obj::resolveClass(name);
            	}
...
HXDLIN( 900)		::lime::utils::Assets_obj::unloadLibrary(name);
            	}
...
HXDLIN( 914)		::openfl::utils::Assets_obj::dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("change",70,91,72,b7),null(),null()));
            	}
