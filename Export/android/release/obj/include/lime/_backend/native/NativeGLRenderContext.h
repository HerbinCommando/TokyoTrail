...
class HXCPP_CLASS_ATTRIBUTES NativeGLRenderContext_obj : public hx::Object
{
	...
	public:
		...
		int clientWaitSync( ::lime::graphics::opengl::GLObject sync,int flags, cpp::Int64Struct timeout);
		...
		void deleteSync( ::lime::graphics::opengl::GLObject sync);
		...
		::Dynamic endTransformFeedback_dyn();
		 ...
		 ::lime::graphics::opengl::GLObject fenceSync(int condition,int flags);
		...
		void getInternalformativ(int target,int internalformat,int pname,Float params);
		...
		::Dynamic getSupportedExtensions_dyn();
		 ...
		 ::Dynamic getSyncParameter( ::lime::graphics::opengl::GLObject sync,int pname);
		::Dynamic getSyncParameter_dyn();

		int getSyncParameteri( ::lime::graphics::opengl::GLObject sync,int pname);
		::Dynamic getSyncParameteri_dyn();

		void getSyncParameteriv( ::lime::graphics::opengl::GLObject sync,int pname,Float params);
		...
		bool isSync( ::lime::graphics::opengl::GLObject sync);
		::Dynamic isSync_dyn();
		...
		void mapBufferRange(int target,Float offset,int length,int access);
		...
		void waitSync( ::lime::graphics::opengl::GLObject sync,int flags, ::Dynamic timeout);
