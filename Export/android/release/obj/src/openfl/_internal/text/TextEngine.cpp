...
HXDLIN( 687)		 ::openfl::_internal::text::TextEngine _gthis = hx::ObjectPtr<OBJ_>(this);
...
HXDLIN( 337)				::String _hx_switch_0 = _g;
            				if (  (_hx_switch_0==HX_("_sans",32,a0,5e,ff)) ){
HXLINE( 372)					fontList = ::Array_obj< ::String >::__new(1)->init(0,(systemFontDirectory + HX_("/DroidSans.ttf",f8,c6,8e,4f)));
HXDLIN( 372)					goto _hx_goto_37;
            				}
            				if (  (_hx_switch_0==HX_("_serif",be,66,15,76)) ){
HXLINE( 377)					goto _hx_goto_37;
            				}
            				if (  (_hx_switch_0==HX_("_typewriter",0c,5e,52,94)) ){
HXLINE( 414)					fontList = ::Array_obj< ::String >::__new(1)->init(0,(systemFontDirectory + HX_("/DroidSansMono.ttf",bb,6c,31,55)));
HXDLIN( 414)					goto _hx_goto_37;
            				}
            				/* default */{
...
HXLINE( 493)		fontList = ::Array_obj< ::String >::__new(2)->init(0,(systemFontDirectory1 + HX_("/DroidSerif-Regular.ttf",57,b0,ef,46)))->init(1,(systemFontDirectory1 + HX_("/NotoSerif-Regular.ttf",59,73,f1,28)));
HXLINE( 500)		{
