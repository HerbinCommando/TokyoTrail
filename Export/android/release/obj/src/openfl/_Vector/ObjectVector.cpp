...
HX_DEFINE_STACK_FRAME(_hx_pos_98c8e9225b0b8e2b_1471_new,"openfl._Vector.ObjectVector","new",0x1b3b8afe,"openfl._Vector.ObjectVector.new","openfl/Vector.hx",1471,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_98c8e9225b0b8e2b_1494_concat,"openfl._Vector.ObjectVector","concat",0x91684536,"openfl._Vector.ObjectVector.concat","openfl/Vector.hx",1494,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_98c8e9225b0b8e2b_1509_copy,"openfl._Vector.ObjectVector","copy",0xb1a04b57,"openfl._Vector.ObjectVector.copy","openfl/Vector.hx",1509,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_98c8e9225b0b8e2b_1516_get,"openfl._Vector.ObjectVector","get",0x1b363b34,"openfl._Vector.ObjectVector.get","openfl/Vector.hx",1516,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_98c8e9225b0b8e2b_1521_indexOf,"openfl._Vector.ObjectVector","indexOf",0x7c5baa67,"openfl._Vector.ObjectVector.indexOf","openfl/Vector.hx",1521,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_98c8e9225b0b8e2b_1540_insertAt,"openfl._Vector.ObjectVector","insertAt",0x4f58852e,"openfl._Vector.ObjectVector.insertAt","openfl/Vector.hx",1540,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_98c8e9225b0b8e2b_1551_iterator,"openfl._Vector.ObjectVector","iterator",0x20d35290,"openfl._Vector.ObjectVector.iterator","openfl/Vector.hx",1551,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_98c8e9225b0b8e2b_1558_join,"openfl._Vector.ObjectVector","join",0xb640c38c,"openfl._Vector.ObjectVector.join","openfl/Vector.hx",1558,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_98c8e9225b0b8e2b_1563_lastIndexOf,"openfl._Vector.ObjectVector","lastIndexOf",0x069b85b1,"openfl._Vector.ObjectVector.lastIndexOf","openfl/Vector.hx",1563,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_98c8e9225b0b8e2b_1581_pop,"openfl._Vector.ObjectVector","pop",0x1b3d182f,"openfl._Vector.ObjectVector.pop","openfl/Vector.hx",1581,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_98c8e9225b0b8e2b_1596_push,"openfl._Vector.ObjectVector","push",0xba3ca17c,"openfl._Vector.ObjectVector.push","openfl/Vector.hx",1596,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_98c8e9225b0b8e2b_1609_reverse,"openfl._Vector.ObjectVector","reverse",0xb6989ac0,"openfl._Vector.ObjectVector.reverse","openfl/Vector.hx",1609,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_98c8e9225b0b8e2b_1619_set,"openfl._Vector.ObjectVector","set",0x1b3f5640,"openfl._Vector.ObjectVector.set","openfl/Vector.hx",1619,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_98c8e9225b0b8e2b_1634_shift,"openfl._Vector.ObjectVector","shift",0xec650aa0,"openfl._Vector.ObjectVector.shift","openfl/Vector.hx",1634,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_98c8e9225b0b8e2b_1649_slice,"openfl._Vector.ObjectVector","slice",0xef09e270,"openfl._Vector.ObjectVector.slice","openfl/Vector.hx",1649,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_98c8e9225b0b8e2b_1656_sort,"openfl._Vector.ObjectVector","sort",0xbc33b700,"openfl._Vector.ObjectVector.sort","openfl/Vector.hx",1656,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_98c8e9225b0b8e2b_1663_splice,"openfl._Vector.ObjectVector","splice",0x8936c19e,"openfl._Vector.ObjectVector.splice","openfl/Vector.hx",1663,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_98c8e9225b0b8e2b_1670_toString,"openfl._Vector.ObjectVector","toString",0xc5a7d94e,"openfl._Vector.ObjectVector.toString","openfl/Vector.hx",1670,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_98c8e9225b0b8e2b_1677_unshift,"openfl._Vector.ObjectVector","unshift",0x14504527,"openfl._Vector.ObjectVector.unshift","openfl/Vector.hx",1677,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_98c8e9225b0b8e2b_1695_get_length,"openfl._Vector.ObjectVector","get_length",0xa394f9d1,"openfl._Vector.ObjectVector.get_length","openfl/Vector.hx",1695,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_98c8e9225b0b8e2b_1700_set_length,"openfl._Vector.ObjectVector","set_length",0xa7129845,"openfl._Vector.ObjectVector.set_length","openfl/Vector.hx",1700,0x4a01873c)
namespace openfl{
namespace _Vector{

void ObjectVector_obj::__construct( ::Dynamic length, ::Dynamic fixed,::cpp::VirtualArray array){
            	HX_STACKFRAME(&_hx_pos_98c8e9225b0b8e2b_1471_new)
HXLINE(1473)		if (hx::IsNull( array )) {
HXLINE(1475)			array = ::cpp::VirtualArray_obj::__new();
            		}
HXLINE(1479)		this->_hx___array = array;
HXLINE(1481)		if (hx::IsNotNull( length )) {
HXLINE(1483)			this->set_length(length);
            		}
HXLINE(1487)		this->fixed = hx::IsEq( fixed,true );
            	}
...
::Dynamic ObjectVector_obj::concat(::Dynamic a){
            	HX_GC_STACKFRAME(&_hx_pos_98c8e9225b0b8e2b_1494_concat)
HXDLIN(1494)		if (hx::IsNull( a )) {
HXLINE(1496)			return  ::openfl::_Vector::ObjectVector_obj::__alloc( HX_CTX ,null(),null(),this->_hx___array->copy());
            		}
            		else {
HXLINE(1500)			::cpp::VirtualArray _hx_tmp = this->_hx___array;
HXDLIN(1500)			return  ::openfl::_Vector::ObjectVector_obj::__alloc( HX_CTX ,null(),null(),_hx_tmp->concat(hx::TCast<  ::openfl::_Vector::ObjectVector >::cast(a)->_hx___array));
            		}
...
::Dynamic ObjectVector_obj::copy(){
            	HX_GC_STACKFRAME(&_hx_pos_98c8e9225b0b8e2b_1509_copy)
HXDLIN(1509)		return  ::openfl::_Vector::ObjectVector_obj::__alloc( HX_CTX ,null(),null(),this->_hx___array->copy());
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(ObjectVector_obj,copy,return )
 ...
 ::Dynamic ObjectVector_obj::get(int index){
            	HX_STACKFRAME(&_hx_pos_98c8e9225b0b8e2b_1516_get)
HXDLIN(1516)		return this->_hx___array->__get(index);
            	}
...
int ObjectVector_obj::indexOf( ::Dynamic x, ::Dynamic __o_from){
 ::Dynamic from = __o_from.Default(0);
            	HX_STACKFRAME(&_hx_pos_98c8e9225b0b8e2b_1521_indexOf)
HXLINE(1523)		{
HXLINE(1523)			int _g1 = from;
HXDLIN(1523)			int _g = this->_hx___array->get_length();
HXDLIN(1523)			while((_g1 < _g)){
HXLINE(1523)				_g1 = (_g1 + (int)1);
HXDLIN(1523)				int i = (_g1 - (int)1);
HXLINE(1525)				if (hx::IsEq( this->_hx___array->__get(i),x )) {
HXLINE(1527)					return i;
            				}
            			}
            		}
HXLINE(1533)		return (int)-1;
            	}
...
void ObjectVector_obj::insertAt(int index, ::Dynamic element){
            	HX_STACKFRAME(&_hx_pos_98c8e9225b0b8e2b_1540_insertAt)
HXDLIN(1540)		bool _hx_tmp;
HXDLIN(1540)		if (!(!(this->fixed))) {
HXDLIN(1540)			_hx_tmp = (index < this->_hx___array->get_length());
            		}
            		else {
HXDLIN(1540)			_hx_tmp = true;
            		}
HXDLIN(1540)		if (_hx_tmp) {
HXLINE(1542)			this->_hx___array->insert(index,element);
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(ObjectVector_obj,insertAt,(void))
 ...
 ::Dynamic ObjectVector_obj::iterator(){
            	HX_STACKFRAME(&_hx_pos_98c8e9225b0b8e2b_1551_iterator)
HXDLIN(1551)		return this->_hx___array->iterator();
            	}
...
::String ObjectVector_obj::join(::String sep){
            	HX_STACKFRAME(&_hx_pos_98c8e9225b0b8e2b_1558_join)
HXDLIN(1558)		return this->_hx___array->join(sep);
            	}
...
int ObjectVector_obj::lastIndexOf( ::Dynamic x, ::Dynamic __o_from){
 ::Dynamic from = __o_from.Default(0);
            	HX_STACKFRAME(&_hx_pos_98c8e9225b0b8e2b_1563_lastIndexOf)
HXLINE(1565)		int i = (this->_hx___array->get_length() - (int)1);
HXLINE(1567)		while(hx::IsGreaterEq( i,from )){
HXLINE(1569)			if (hx::IsEq( this->_hx___array->__get(i),x )) {
HXLINE(1569)				return i;
            			}
HXLINE(1570)			i = (i - (int)1);
            		}
HXLINE(1574)		return (int)-1;
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(ObjectVector_obj,lastIndexOf,return )
 ...
 ::Dynamic ObjectVector_obj::pop(){
            	HX_STACKFRAME(&_hx_pos_98c8e9225b0b8e2b_1581_pop)
HXDLIN(1581)		if (!(this->fixed)) {
HXLINE(1583)			return this->_hx___array->pop();
            		}
            		else {
HXLINE(1587)			return null();
            		}
...
int ObjectVector_obj::push( ::Dynamic x){
            	HX_STACKFRAME(&_hx_pos_98c8e9225b0b8e2b_1596_push)
HXDLIN(1596)		if (!(this->fixed)) {
HXLINE(1598)			return this->_hx___array->push(x);
            		}
            		else {
HXLINE(1602)			return this->_hx___array->get_length();
            		}
...
::Dynamic ObjectVector_obj::reverse(){
            	HX_STACKFRAME(&_hx_pos_98c8e9225b0b8e2b_1609_reverse)
HXLINE(1611)		this->_hx___array->reverse();
HXLINE(1612)		return hx::ObjectPtr<OBJ_>(this);
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(ObjectVector_obj,reverse,return )
 ...
 ::Dynamic ObjectVector_obj::set(int index, ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_98c8e9225b0b8e2b_1619_set)
HXDLIN(1619)		bool _hx_tmp;
HXDLIN(1619)		if (!(!(this->fixed))) {
HXDLIN(1619)			_hx_tmp = (index < this->_hx___array->get_length());
            		}
            		else {
HXDLIN(1619)			_hx_tmp = true;
            		}
HXDLIN(1619)		if (_hx_tmp) {
HXLINE(1621)			return (this->_hx___array->set(index,value));
            		}
            		else {
...
HX_DEFINE_DYNAMIC_FUNC2(ObjectVector_obj,set,return )
 ...
 ::Dynamic ObjectVector_obj::shift(){
            	HX_STACKFRAME(&_hx_pos_98c8e9225b0b8e2b_1634_shift)
HXDLIN(1634)		if (!(this->fixed)) {
HXLINE(1636)			return this->_hx___array->shift();
            		}
            		else {
...
::Dynamic ObjectVector_obj::slice( ::Dynamic __o_startIndex, ::Dynamic __o_endIndex){
 ...
 ::Dynamic endIndex = __o_endIndex.Default(16777215);
            	HX_GC_STACKFRAME(&_hx_pos_98c8e9225b0b8e2b_1649_slice)
HXDLIN(1649)		return  ::openfl::_Vector::ObjectVector_obj::__alloc( HX_CTX ,null(),null(),this->_hx___array->slice(startIndex,endIndex));
            	}
...
void ObjectVector_obj::sort( ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_98c8e9225b0b8e2b_1656_sort)
HXDLIN(1656)		this->_hx___array->sort(f);
            	}
...
::Dynamic ObjectVector_obj::splice(int pos,int len){
            	HX_GC_STACKFRAME(&_hx_pos_98c8e9225b0b8e2b_1663_splice)
HXDLIN(1663)		return  ::openfl::_Vector::ObjectVector_obj::__alloc( HX_CTX ,null(),null(),this->_hx___array->splice(pos,len));
            	}
...
::String ObjectVector_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_98c8e9225b0b8e2b_1670_toString)
HXDLIN(1670)		if (hx::IsNotNull( this->_hx___array )) {
HXDLIN(1670)			return this->_hx___array->toString();
            		}
            		else {
HXDLIN(1670)			return null();
            		}
HXDLIN(1670)		return null();
            	}
...
void ObjectVector_obj::unshift( ::Dynamic x){
            	HX_STACKFRAME(&_hx_pos_98c8e9225b0b8e2b_1677_unshift)
HXDLIN(1677)		if (!(this->fixed)) {
HXLINE(1679)			this->_hx___array->unshift(x);
            		}
            	}
...
int ObjectVector_obj::get_length(){
            	HX_STACKFRAME(&_hx_pos_98c8e9225b0b8e2b_1695_get_length)
HXDLIN(1695)		return this->_hx___array->get_length();
            	}
...
int ObjectVector_obj::set_length(int value){
            	HX_STACKFRAME(&_hx_pos_98c8e9225b0b8e2b_1700_set_length)
HXLINE(1702)		if (!(this->fixed)) {
HXLINE(1706)			_hx_array_set_size_exact(this->_hx___array,value);
            		}
HXLINE(1735)		return this->_hx___array->get_length();
            	}
