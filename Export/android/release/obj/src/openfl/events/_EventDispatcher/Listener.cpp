...
HX_DEFINE_STACK_FRAME(_hx_pos_4056b9d72619ced0_377_new,"openfl.events._EventDispatcher.Listener","new",0x63be323b,"openfl.events._EventDispatcher.Listener.new","openfl/events/EventDispatcher.hx",377,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_4056b9d72619ced0_388_match,"openfl.events._EventDispatcher.Listener","match",0xdf4e17e0,"openfl.events._EventDispatcher.Listener.match","openfl/events/EventDispatcher.hx",388,0xe2270714)
namespace openfl{
namespace events{
namespace _EventDispatcher{

void Listener_obj::__construct( ::Dynamic callback,bool useCapture,int priority){
            	HX_STACKFRAME(&_hx_pos_4056b9d72619ced0_377_new)
HXLINE( 379)		this->callback = callback;
HXLINE( 380)		this->useCapture = useCapture;
HXLINE( 381)		this->priority = priority;
            	}
...
bool Listener_obj::match( ::Dynamic callback,bool useCapture){
            	HX_STACKFRAME(&_hx_pos_4056b9d72619ced0_388_match)
HXDLIN( 388)		if (::Reflect_obj::compareMethods(this->callback,callback)) {
HXDLIN( 388)			return (this->useCapture == useCapture);
            		}
            		else {
