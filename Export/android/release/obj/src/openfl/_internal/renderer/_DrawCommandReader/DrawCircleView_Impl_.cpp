...
HX_LOCAL_STACK_FRAME(_hx_pos_da30b9c34d98d85b_292__new,"openfl._internal.renderer._DrawCommandReader.DrawCircleView_Impl_","_new",0xd771db4e,"openfl._internal.renderer._DrawCommandReader.DrawCircleView_Impl_._new","openfl/_internal/renderer/DrawCommandReader.hx",292,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_da30b9c34d98d85b_293_get_x,"openfl._internal.renderer._DrawCommandReader.DrawCircleView_Impl_","get_x",0x417b0ec2,"openfl._internal.renderer._DrawCommandReader.DrawCircleView_Impl_.get_x","openfl/_internal/renderer/DrawCommandReader.hx",293,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_da30b9c34d98d85b_294_get_y,"openfl._internal.renderer._DrawCommandReader.DrawCircleView_Impl_","get_y",0x417b0ec3,"openfl._internal.renderer._DrawCommandReader.DrawCircleView_Impl_.get_y","openfl/_internal/renderer/DrawCommandReader.hx",294,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_da30b9c34d98d85b_295_get_radius,"openfl._internal.renderer._DrawCommandReader.DrawCircleView_Impl_","get_radius",0xc711b5c8,"openfl._internal.renderer._DrawCommandReader.DrawCircleView_Impl_.get_radius","openfl/_internal/renderer/DrawCommandReader.hx",295,0xbbdbd1ae)
namespace openfl{
namespace _internal{
namespace renderer{
...
HXDLIN( 292)		 ::openfl::_internal::renderer::DrawCommandReader this1 = d;
HXDLIN( 292)		return this1;
            	}
...
HXDLIN( 293)		return this1->buffer->f->__get(this1->fPos);
            	}
...
HXDLIN( 294)		::Array< Float > this2 = this1->buffer->f;
HXDLIN( 294)		return this2->__get((this1->fPos + (int)1));
            	}
...
HXDLIN( 295)		::Array< Float > this2 = this1->buffer->f;
HXDLIN( 295)		return this2->__get((this1->fPos + (int)2));
            	}
