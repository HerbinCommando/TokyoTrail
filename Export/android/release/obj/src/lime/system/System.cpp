...
HXLINE( 165)		if ((code == (int)0)) {
HXLINE( 167)			 ::lime::_hx_system::JNIStaticField mainActivity = ::lime::_hx_system::JNI_obj::createStaticField(HX_("org/haxe/extension/Extension",b1,f4,56,51),HX_("mainActivity",28,83,72,14),HX_("Landroid/app/Activity;",52,cb,53,45));
HXLINE( 168)			 ::Dynamic moveTaskToBack = ::lime::_hx_system::JNI_obj::createMemberMethod(HX_("android/app/Activity",7d,f6,a1,af),HX_("moveTaskToBack",d8,80,a8,0c),HX_("(Z)Z",c3,f7,b4,1a),null(),null());
HXLINE( 170)			moveTaskToBack(mainActivity->get(),true);
            		}
...
HXLINE( 220)			 ::Dynamic getDisplayDPI = ::lime::_hx_system::JNI_obj::createStaticMethod(HX_("org/haxe/lime/GameActivity",1d,61,c7,a4),HX_("getDisplayDPI",71,66,32,3a),HX_("()D",23,7e,1e,00),null(),null());
HXLINE( 221)			display->dpi = ::Math_obj::round(( (Float)(getDisplayDPI()) ));
...
HXDLIN( 296)		return ::lime::_backend::native::NativeCFFI_obj::cffi_lime_system_get_timer();
            	}
...
HXDLIN( 312)		return ::lime::_hx_system::CFFI_obj::load(library,method,args,lazy);
            	}
...
HXDLIN( 322)		if (hx::IsNotNull( path )) {
HXLINE( 346)			 ::Dynamic openFile = ::lime::_hx_system::JNI_obj::createStaticMethod(HX_("org/haxe/lime/GameActivity",1d,61,c7,a4),HX_("openFile",66,ab,f7,e4),HX_("(Ljava/lang/String;)V",7f,b4,bc,c7),null(),null());
HXLINE( 347)			openFile(path);
            		}
            	}
...
HXDLIN( 362)		if (hx::IsNotNull( url )) {
HXLINE( 378)			 ::Dynamic openURL = ::lime::_hx_system::JNI_obj::createStaticMethod(HX_("org/haxe/lime/GameActivity",1d,61,c7,a4),HX_("openURL",c5,bd,35,40),HX_("(Ljava/lang/String;Ljava/lang/String;)V",49,45,e8,06),null(),null());
HXLINE( 379)			openURL(url,target);
            		}
            	}
...
HXDLIN( 413)		if (::lime::_hx_system::System_obj::_hx___directories->exists(type)) {
HXLINE( 415)			return ( (::String)(::lime::_hx_system::System_obj::_hx___directories->get(type)) );
            		}
            		else {
...
HXLINE( 453)			::String seperator = HX_("/",2f,00,00,00);
...
HXDLIN( 522)		return ::lime::_backend::native::NativeCFFI_obj::cffi_lime_system_get_allow_screen_timeout();
            	}
...
HXDLIN( 533)		return ::lime::_backend::native::NativeCFFI_obj::cffi_lime_system_set_allow_screen_timeout(value);
            	}
...
HXDLIN( 543)		return ::lime::_hx_system::System_obj::_hx___getDirectory((int)0);
            	}
...
HXDLIN( 550)		return ::lime::_hx_system::System_obj::_hx___getDirectory((int)1);
            	}
...
HXDLIN( 557)		return ::lime::_hx_system::System_obj::_hx___getDirectory((int)2);
            	}
...
HXDLIN( 564)		return ::lime::_hx_system::System_obj::_hx___getDirectory((int)3);
            	}
...
HXDLIN( 571)		return ::lime::_hx_system::System_obj::_hx___getDirectory((int)4);
            	}
...
HXDLIN( 579)		return ::lime::_backend::native::NativeCFFI_obj::cffi_lime_system_get_num_displays();
            	}
...
HXDLIN( 589)		return ::lime::_hx_system::System_obj::_hx___getDirectory((int)5);
            	}
...
HXDLIN( 601)		return ::lime::_hx_system::Endian_obj::_hx_LITTLE_ENDIAN_dyn();
            	}
