...
HXLINE(  61)		this->clearDirtyFlags = false;
            	}
...
void RenderSession_obj::__Mark(HX_MARK_PARAMS)
{
	...
	HX_MARK_MEMBER_NAME(clearDirtyFlags,"clearDirtyFlags");
...
void RenderSession_obj::__Visit(HX_VISIT_PARAMS)
{
	...
	HX_VISIT_MEMBER_NAME(clearDirtyFlags,"clearDirtyFlags");
...
hx::Val RenderSession_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
	...
	case 14:
		...
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"clearDirtyFlags") ) { return hx::Val( clearDirtyFlags ); }
		break;
	case 16:
...
hx::Val RenderSession_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	...
	case 14:
		...
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"clearDirtyFlags") ) { clearDirtyFlags=inValue.Cast< bool >(); return inValue; }
		break;
	case 16:
...
void RenderSession_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_HCSTRING("clearDirtyFlags","\xc2","\x91","\xd8","\x6f"));
...
static hx::StorageInfo RenderSession_obj_sMemberStorageInfo[] = {
	...
	{hx::fsBool,(int)offsetof(RenderSession_obj,clearDirtyFlags),HX_HCSTRING("clearDirtyFlags","\xc2","\x91","\xd8","\x6f")},
...
static ::String RenderSession_obj_sMemberFields[] = {
	...
	HX_HCSTRING("clearDirtyFlags","\xc2","\x91","\xd8","\x6f"),
