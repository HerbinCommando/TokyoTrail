...
HX_DEFINE_STACK_FRAME(_hx_pos_0ca25ed6048e1cbf_1182_new,"openfl._Vector.IntVector","new",0x6313ae9a,"openfl._Vector.IntVector.new","openfl/Vector.hx",1182,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_0ca25ed6048e1cbf_1205_concat,"openfl._Vector.IntVector","concat",0x4a254b1a,"openfl._Vector.IntVector.concat","openfl/Vector.hx",1205,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_0ca25ed6048e1cbf_1220_copy,"openfl._Vector.IntVector","copy",0x46e7503b,"openfl._Vector.IntVector.copy","openfl/Vector.hx",1220,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_0ca25ed6048e1cbf_1227_get,"openfl._Vector.IntVector","get",0x630e5ed0,"openfl._Vector.IntVector.get","openfl/Vector.hx",1227,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_0ca25ed6048e1cbf_1232_indexOf,"openfl._Vector.IntVector","indexOf",0x6903cc03,"openfl._Vector.IntVector.indexOf","openfl/Vector.hx",1232,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_0ca25ed6048e1cbf_1251_insertAt,"openfl._Vector.IntVector","insertAt",0x75cdcc12,"openfl._Vector.IntVector.insertAt","openfl/Vector.hx",1251,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_0ca25ed6048e1cbf_1262_iterator,"openfl._Vector.IntVector","iterator",0x47489974,"openfl._Vector.IntVector.iterator","openfl/Vector.hx",1262,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_0ca25ed6048e1cbf_1269_join,"openfl._Vector.IntVector","join",0x4b87c870,"openfl._Vector.IntVector.join","openfl/Vector.hx",1269,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_0ca25ed6048e1cbf_1274_lastIndexOf,"openfl._Vector.IntVector","lastIndexOf",0x72eaa54d,"openfl._Vector.IntVector.lastIndexOf","openfl/Vector.hx",1274,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_0ca25ed6048e1cbf_1292_pop,"openfl._Vector.IntVector","pop",0x63153bcb,"openfl._Vector.IntVector.pop","openfl/Vector.hx",1292,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_0ca25ed6048e1cbf_1307_push,"openfl._Vector.IntVector","push",0x4f83a660,"openfl._Vector.IntVector.push","openfl/Vector.hx",1307,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_0ca25ed6048e1cbf_1320_reverse,"openfl._Vector.IntVector","reverse",0xa340bc5c,"openfl._Vector.IntVector.reverse","openfl/Vector.hx",1320,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_0ca25ed6048e1cbf_1330_set,"openfl._Vector.IntVector","set",0x631779dc,"openfl._Vector.IntVector.set","openfl/Vector.hx",1330,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_0ca25ed6048e1cbf_1345_shift,"openfl._Vector.IntVector","shift",0xf5424d3c,"openfl._Vector.IntVector.shift","openfl/Vector.hx",1345,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_0ca25ed6048e1cbf_1360_slice,"openfl._Vector.IntVector","slice",0xf7e7250c,"openfl._Vector.IntVector.slice","openfl/Vector.hx",1360,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_0ca25ed6048e1cbf_1367_sort,"openfl._Vector.IntVector","sort",0x517abbe4,"openfl._Vector.IntVector.sort","openfl/Vector.hx",1367,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_0ca25ed6048e1cbf_1374_splice,"openfl._Vector.IntVector","splice",0x41f3c782,"openfl._Vector.IntVector.splice","openfl/Vector.hx",1374,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_0ca25ed6048e1cbf_1381_toString,"openfl._Vector.IntVector","toString",0xec1d2032,"openfl._Vector.IntVector.toString","openfl/Vector.hx",1381,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_0ca25ed6048e1cbf_1388_unshift,"openfl._Vector.IntVector","unshift",0x00f866c3,"openfl._Vector.IntVector.unshift","openfl/Vector.hx",1388,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_0ca25ed6048e1cbf_1406_get_length,"openfl._Vector.IntVector","get_length",0x4714c1b5,"openfl._Vector.IntVector.get_length","openfl/Vector.hx",1406,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_0ca25ed6048e1cbf_1411_set_length,"openfl._Vector.IntVector","set_length",0x4a926029,"openfl._Vector.IntVector.set_length","openfl/Vector.hx",1411,0x4a01873c)
namespace openfl{
namespace _Vector{

void IntVector_obj::__construct( ::Dynamic length, ::Dynamic fixed,::Array< int > array){
            	HX_STACKFRAME(&_hx_pos_0ca25ed6048e1cbf_1182_new)
HXLINE(1184)		if (hx::IsNull( array )) {
HXLINE(1186)			array = ::Array_obj< int >::__new();
            		}
HXLINE(1190)		this->_hx___array = array;
HXLINE(1192)		if (hx::IsNotNull( length )) {
HXLINE(1194)			this->set_length(length);
            		}
HXLINE(1198)		this->fixed = hx::IsEq( fixed,true );
            	}
...
::Dynamic IntVector_obj::concat(::Dynamic a){
            	HX_GC_STACKFRAME(&_hx_pos_0ca25ed6048e1cbf_1205_concat)
HXDLIN(1205)		if (hx::IsNull( a )) {
HXLINE(1207)			return  ::openfl::_Vector::IntVector_obj::__alloc( HX_CTX ,null(),null(),this->_hx___array->copy());
            		}
            		else {
HXLINE(1211)			::Array< int > _hx_tmp = this->_hx___array;
HXDLIN(1211)			return  ::openfl::_Vector::IntVector_obj::__alloc( HX_CTX ,null(),null(),_hx_tmp->concat(hx::TCast<  ::openfl::_Vector::IntVector >::cast(a)->_hx___array));
            		}
HXLINE(1205)		return null();
            	}
...
::Dynamic IntVector_obj::copy(){
            	HX_GC_STACKFRAME(&_hx_pos_0ca25ed6048e1cbf_1220_copy)
HXDLIN(1220)		bool _hx_tmp = this->fixed;
HXDLIN(1220)		return  ::openfl::_Vector::IntVector_obj::__alloc( HX_CTX ,null(),_hx_tmp,this->_hx___array->copy());
            	}
...
int IntVector_obj::get(int index){
            	HX_STACKFRAME(&_hx_pos_0ca25ed6048e1cbf_1227_get)
HXDLIN(1227)		return this->_hx___array->__get(index);
            	}
...
int IntVector_obj::indexOf(int x, ::Dynamic __o_from){
 ::Dynamic from = __o_from.Default(0);
            	HX_STACKFRAME(&_hx_pos_0ca25ed6048e1cbf_1232_indexOf)
HXLINE(1234)		{
HXLINE(1234)			int _g1 = from;
HXDLIN(1234)			int _g = this->_hx___array->length;
HXDLIN(1234)			while((_g1 < _g)){
HXLINE(1234)				_g1 = (_g1 + (int)1);
HXDLIN(1234)				int i = (_g1 - (int)1);
HXLINE(1236)				if ((this->_hx___array->__get(i) == x)) {
HXLINE(1238)					return i;
            				}
            			}
            		}
...
void IntVector_obj::insertAt(int index,int element){
            	HX_STACKFRAME(&_hx_pos_0ca25ed6048e1cbf_1251_insertAt)
HXDLIN(1251)		bool _hx_tmp;
HXDLIN(1251)		if (!(!(this->fixed))) {
HXDLIN(1251)			_hx_tmp = (index < this->_hx___array->length);
            		}
            		else {
HXDLIN(1251)			_hx_tmp = true;
            		}
HXDLIN(1251)		if (_hx_tmp) {
HXLINE(1253)			this->_hx___array->insert(index,element);
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(IntVector_obj,insertAt,(void))
 ...
 ::Dynamic IntVector_obj::iterator(){
            	HX_STACKFRAME(&_hx_pos_0ca25ed6048e1cbf_1262_iterator)
HXDLIN(1262)		return this->_hx___array->iterator();
            	}
...
::String IntVector_obj::join(::String sep){
            	HX_STACKFRAME(&_hx_pos_0ca25ed6048e1cbf_1269_join)
HXDLIN(1269)		return this->_hx___array->join(sep);
            	}
...
int IntVector_obj::lastIndexOf(int x, ::Dynamic __o_from){
 ::Dynamic from = __o_from.Default(0);
            	HX_STACKFRAME(&_hx_pos_0ca25ed6048e1cbf_1274_lastIndexOf)
HXLINE(1276)		int i = (this->_hx___array->length - (int)1);
HXLINE(1278)		while(hx::IsGreaterEq( i,from )){
HXLINE(1280)			if ((this->_hx___array->__get(i) == x)) {
HXLINE(1280)				return i;
            			}
HXLINE(1281)			i = (i - (int)1);
            		}
HXLINE(1285)		return (int)-1;
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(IntVector_obj,lastIndexOf,return )
 ...
 ::Dynamic IntVector_obj::pop(){
            	HX_STACKFRAME(&_hx_pos_0ca25ed6048e1cbf_1292_pop)
HXDLIN(1292)		if (!(this->fixed)) {
HXLINE(1294)			return this->_hx___array->pop();
            		}
            		else {
HXLINE(1298)			return null();
            		}
HXLINE(1292)		return (int)0;
            	}
...
int IntVector_obj::push(int x){
            	HX_STACKFRAME(&_hx_pos_0ca25ed6048e1cbf_1307_push)
HXDLIN(1307)		if (!(this->fixed)) {
HXLINE(1309)			return this->_hx___array->push(x);
            		}
            		else {
HXLINE(1313)			return this->_hx___array->length;
            		}
HXLINE(1307)		return (int)0;
            	}
...
::Dynamic IntVector_obj::reverse(){
            	HX_STACKFRAME(&_hx_pos_0ca25ed6048e1cbf_1320_reverse)
HXLINE(1322)		this->_hx___array->reverse();
HXLINE(1323)		return hx::ObjectPtr<OBJ_>(this);
            	}
...
int IntVector_obj::set(int index,int value){
            	HX_STACKFRAME(&_hx_pos_0ca25ed6048e1cbf_1330_set)
HXDLIN(1330)		bool _hx_tmp;
HXDLIN(1330)		if (!(!(this->fixed))) {
HXDLIN(1330)			_hx_tmp = (index < this->_hx___array->length);
            		}
            		else {
HXDLIN(1330)			_hx_tmp = true;
            		}
HXDLIN(1330)		if (_hx_tmp) {
HXLINE(1332)			return (this->_hx___array[index] = value);
            		}
            		else {
HXLINE(1336)			return value;
            		}
...
HX_DEFINE_DYNAMIC_FUNC2(IntVector_obj,set,return )
 ...
 ::Dynamic IntVector_obj::shift(){
            	HX_STACKFRAME(&_hx_pos_0ca25ed6048e1cbf_1345_shift)
HXDLIN(1345)		if (!(this->fixed)) {
HXLINE(1347)			return this->_hx___array->shift();
            		}
            		else {
HXLINE(1351)			return null();
            		}
HXLINE(1345)		return (int)0;
            	}
...
::Dynamic IntVector_obj::slice( ::Dynamic __o_startIndex, ::Dynamic __o_endIndex){
 ...
 ::Dynamic endIndex = __o_endIndex.Default(16777215);
            	HX_GC_STACKFRAME(&_hx_pos_0ca25ed6048e1cbf_1360_slice)
HXDLIN(1360)		return  ::openfl::_Vector::IntVector_obj::__alloc( HX_CTX ,null(),null(),this->_hx___array->slice(startIndex,endIndex));
            	}
...
void IntVector_obj::sort( ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_0ca25ed6048e1cbf_1367_sort)
HXDLIN(1367)		this->_hx___array->sort(f);
            	}
...
::Dynamic IntVector_obj::splice(int pos,int len){
            	HX_GC_STACKFRAME(&_hx_pos_0ca25ed6048e1cbf_1374_splice)
HXDLIN(1374)		return  ::openfl::_Vector::IntVector_obj::__alloc( HX_CTX ,null(),null(),this->_hx___array->splice(pos,len));
            	}
...
::String IntVector_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_0ca25ed6048e1cbf_1381_toString)
HXDLIN(1381)		if (hx::IsNotNull( this->_hx___array )) {
HXDLIN(1381)			return this->_hx___array->toString();
            		}
            		else {
HXDLIN(1381)			return null();
            		}
HXDLIN(1381)		return null();
            	}
...
void IntVector_obj::unshift(int x){
            	HX_STACKFRAME(&_hx_pos_0ca25ed6048e1cbf_1388_unshift)
HXDLIN(1388)		if (!(this->fixed)) {
HXLINE(1390)			this->_hx___array->unshift(x);
            		}
            	}
...
int IntVector_obj::get_length(){
            	HX_STACKFRAME(&_hx_pos_0ca25ed6048e1cbf_1406_get_length)
HXDLIN(1406)		return this->_hx___array->length;
            	}
...
int IntVector_obj::set_length(int value){
            	HX_STACKFRAME(&_hx_pos_0ca25ed6048e1cbf_1411_set_length)
HXLINE(1413)		if (!(this->fixed)) {
HXLINE(1417)			_hx_array_set_size_exact(this->_hx___array,value);
            		}
HXLINE(1446)		return this->_hx___array->length;
            	}
