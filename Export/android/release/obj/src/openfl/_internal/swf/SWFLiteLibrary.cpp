...
HX_LOCAL_STACK_FRAME(_hx_pos_f3ab34383ae5e3ff_136_getMovieClip,"openfl._internal.swf.SWFLiteLibrary","getMovieClip",0x5607f2b1,"openfl._internal.swf.SWFLiteLibrary.getMovieClip","openfl/_internal/swf/SWFLiteLibrary.hx",136,0xbec32034)
HX_LOCAL_STACK_FRAME(_hx_pos_f3ab34383ae5e3ff_143_isLocal,"openfl._internal.swf.SWFLiteLibrary","isLocal",0x6a6ec6fa,"openfl._internal.swf.SWFLiteLibrary.isLocal","openfl/_internal/swf/SWFLiteLibrary.hx",143,0xbec32034)
HX_LOCAL_STACK_FRAME(_hx_pos_f3ab34383ae5e3ff_186_load,"openfl._internal.swf.SWFLiteLibrary","load",0x35eb8ead,"openfl._internal.swf.SWFLiteLibrary.load","openfl/_internal/swf/SWFLiteLibrary.hx",186,0xbec32034)
HX_LOCAL_STACK_FRAME(_hx_pos_f3ab34383ae5e3ff_159_load,"openfl._internal.swf.SWFLiteLibrary","load",0x35eb8ead,"openfl._internal.swf.SWFLiteLibrary.load","openfl/_internal/swf/SWFLiteLibrary.hx",159,0xbec32034)
HX_LOCAL_STACK_FRAME(_hx_pos_f3ab34383ae5e3ff_148_load,"openfl._internal.swf.SWFLiteLibrary","load",0x35eb8ead,"openfl._internal.swf.SWFLiteLibrary.load","openfl/_internal/swf/SWFLiteLibrary.hx",148,0xbec32034)
HX_LOCAL_STACK_FRAME(_hx_pos_f3ab34383ae5e3ff_218_load,"openfl._internal.swf.SWFLiteLibrary","load",0x35eb8ead,"openfl._internal.swf.SWFLiteLibrary.load","openfl/_internal/swf/SWFLiteLibrary.hx",218,0xbec32034)
...
HX_LOCAL_STACK_FRAME(_hx_pos_f3ab34383ae5e3ff_229_loadImage,"openfl._internal.swf.SWFLiteLibrary","loadImage",0x9fc5ad6e,"openfl._internal.swf.SWFLiteLibrary.loadImage","openfl/_internal/swf/SWFLiteLibrary.hx",229,0xbec32034)
HX_LOCAL_STACK_FRAME(_hx_pos_f3ab34383ae5e3ff_253_loadImage,"openfl._internal.swf.SWFLiteLibrary","loadImage",0x9fc5ad6e,"openfl._internal.swf.SWFLiteLibrary.loadImage","openfl/_internal/swf/SWFLiteLibrary.hx",253,0xbec32034)
HX_LOCAL_STACK_FRAME(_hx_pos_f3ab34383ae5e3ff_281_unload,"openfl._internal.swf.SWFLiteLibrary","unload",0x400c0546,"openfl._internal.swf.SWFLiteLibrary.unload","openfl/_internal/swf/SWFLiteLibrary.hx",281,0xbec32034)
HX_LOCAL_STACK_FRAME(_hx_pos_f3ab34383ae5e3ff_299___copyChannel,"openfl._internal.swf.SWFLiteLibrary","__copyChannel",0x00518107,"openfl._internal.swf.SWFLiteLibrary.__copyChannel","openfl/_internal/swf/SWFLiteLibrary.hx",299,0xbec32034)
HX_LOCAL_STACK_FRAME(_hx_pos_f3ab34383ae5e3ff_316___fromManifest,"openfl._internal.swf.SWFLiteLibrary","__fromManifest",0x5078dda0,"openfl._internal.swf.SWFLiteLibrary.__fromManifest","openfl/_internal/swf/SWFLiteLibrary.hx",316,0xbec32034)
HX_LOCAL_STACK_FRAME(_hx_pos_f3ab34383ae5e3ff_326___load,"openfl._internal.swf.SWFLiteLibrary","__load",0xd12f618d,"openfl._internal.swf.SWFLiteLibrary.__load","openfl/_internal/swf/SWFLiteLibrary.hx",326,0xbec32034)
HX_LOCAL_STACK_FRAME(_hx_pos_f3ab34383ae5e3ff_333___loadImage,"openfl._internal.swf.SWFLiteLibrary","__loadImage",0xd3596e8e,"openfl._internal.swf.SWFLiteLibrary.__loadImage","openfl/_internal/swf/SWFLiteLibrary.hx",333,0xbec32034)
namespace openfl{
namespace _internal{
namespace swf{
...
HXLINE( 117)						this->alphaCheck->set(id,true);
HXLINE( 119)						return image;
            					}
            				}
            			}
            		}
HXLINE( 129)		return this->super::getImage(id);
            	}


 ::openfl::display::MovieClip SWFLiteLibrary_obj::getMovieClip(::String id){
            	HX_STACKFRAME(&_hx_pos_f3ab34383ae5e3ff_136_getMovieClip)
HXDLIN( 136)		if (hx::IsNotNull( this->swf )) {
HXDLIN( 136)			return this->swf->createMovieClip(id);
            		}
            		else {
...
bool SWFLiteLibrary_obj::isLocal(::String id,::String type){
            	HX_STACKFRAME(&_hx_pos_f3ab34383ae5e3ff_143_isLocal)
HXDLIN( 143)		return true;
            	}
 ...
 ::lime::app::Future SWFLiteLibrary_obj::load(){
            		...
            		void _hx_run(::String data){
            			...
            			void _hx_run( ::lime::utils::AssetLibrary _){
            				HX_GC_STACKFRAME(&_hx_pos_f3ab34383ae5e3ff_186_load)
HXLINE( 188)				_gthis->preloading = false;
HXLINE( 189)				promise->complete(_gthis);
            			}
            			HX_END_LOCAL_FUNC1((void))

            			HX_GC_STACKFRAME(&_hx_pos_f3ab34383ae5e3ff_159_load)
HXLINE( 161)			_gthis->cachedText->set(_gthis->id,data);
HXLINE( 163)			_gthis->swf = ::openfl::_internal::swf::SWFLite_obj::unserialize(data);
HXLINE( 164)			_gthis->swf->library = _gthis;
HXLINE( 166)			 ::openfl::_internal::symbols::BitmapSymbol bitmapSymbol;
HXLINE( 168)			{
HXLINE( 168)				 ::Dynamic symbol = _gthis->swf->symbols->iterator();
HXDLIN( 168)				while(( (bool)(symbol->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 168)					 ::openfl::_internal::symbols::SWFSymbol symbol1 = ( ( ::openfl::_internal::symbols::SWFSymbol)(symbol->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXLINE( 170)					if (::Std_obj::is(symbol1,hx::ClassOf< ::openfl::_internal::symbols::BitmapSymbol >())) {
HXLINE( 172)						bitmapSymbol = ( ( ::openfl::_internal::symbols::BitmapSymbol)(symbol1) );
HXLINE( 174)						if (hx::IsNotNull( bitmapSymbol->className )) {
HXLINE( 176)							_gthis->imageClassNames->set(bitmapSymbol->className,bitmapSymbol->path);
            						}
            					}
            				}
            			}
HXLINE( 184)			::openfl::_internal::swf::SWFLite_obj::instances->set(_gthis->id,_gthis->swf);
HXLINE( 186)			_gthis->_hx___load()->onProgress(promise->progress_dyn())->onError(promise->error_dyn())->onComplete( ::Dynamic(new _hx_Closure_0(_gthis,promise)));
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_GC_STACKFRAME(&_hx_pos_f3ab34383ae5e3ff_148_load)
HXDLIN( 148)		 ::openfl::_internal::swf::SWFLiteLibrary _gthis = hx::ObjectPtr<OBJ_>(this);
HXLINE( 150)		if (hx::IsNotNull( this->id )) {
HXLINE( 152)			this->preload->set(this->id,true);
            		}
HXLINE( 156)		 ::lime::app::Promise_lime_utils_AssetLibrary promise =  ::lime::app::Promise_lime_utils_AssetLibrary_obj::__alloc( HX_CTX );
HXLINE( 157)		this->preloading = true;
HXLINE( 159)		 ::Dynamic onComplete =  ::Dynamic(new _hx_Closure_1(_gthis,promise));
HXLINE( 195)		if (::openfl::utils::Assets_obj::exists(this->id,null())) {
HXLINE( 205)			this->loadText(this->id)->onError(promise->error_dyn())->onComplete(onComplete);
            		}
            		else {
            			...
            			void _hx_run( ::Dynamic _1){
            				HX_GC_STACKFRAME(&_hx_pos_f3ab34383ae5e3ff_218_load)
HXLINE( 218)				onComplete(loader->data);
            			}
            			HX_END_LOCAL_FUNC1((void))
...
HXLINE( 219)				promise->error(e);
            			}
            			HX_END_LOCAL_FUNC1((void))

HXLINE( 209)			{
HXLINE( 209)				 ::Dynamic id = this->paths->keys();
HXDLIN( 209)				while(( (bool)(id->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 209)					::String id1 = ( (::String)(id->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXLINE( 211)					this->preload->set(id1,true);
            				}
            			}
HXLINE( 215)			::String path;
HXDLIN( 215)			bool path1;
HXDLIN( 215)			if (hx::IsNotNull( this->rootPath )) {
HXLINE( 215)				path1 = (this->rootPath != HX_("",00,00,00,00));
            			}
            			else {
HXLINE( 215)				path1 = false;
            			}
HXDLIN( 215)			if (path1) {
HXLINE( 215)				path = ((this->rootPath + HX_("/",2f,00,00,00)) + this->id);
            			}
            			else {
HXLINE( 215)				path = this->id;
            			}
HXLINE( 217)			 ::openfl::net::URLLoader loader =  ::openfl::net::URLLoader_obj::__alloc( HX_CTX ,null());
HXLINE( 218)			loader->addEventListener(HX_("complete",b9,00,c8,7f), ::Dynamic(new _hx_Closure_2(loader,onComplete)),null(),null(),null());
HXLINE( 219)			loader->addEventListener(HX_("ioError",02,fe,41,76), ::Dynamic(new _hx_Closure_3(promise)),null(),null(),null());
HXLINE( 220)			loader->load( ::openfl::net::URLRequest_obj::__alloc( HX_CTX ,path));
            		}
HXLINE( 224)		return promise->future;
            	}


 ::lime::app::Future SWFLiteLibrary_obj::loadImage(::String id){
            	HX_GC_STACKFRAME(&_hx_pos_f3ab34383ae5e3ff_229_loadImage)
HXDLIN( 229)		 ::openfl::_internal::swf::SWFLiteLibrary _gthis = hx::ObjectPtr<OBJ_>(this);
HXLINE( 231)		if (this->imageClassNames->exists(id)) {
HXLINE( 233)			id = ( (::String)(this->imageClassNames->get(id)) );
            		}
HXLINE( 239)		bool _hx_tmp;
HXDLIN( 239)		if (!(this->preloading)) {
HXLINE( 239)			_hx_tmp = !(this->alphaCheck->exists(id));
            		}
            		else {
HXLINE( 239)			_hx_tmp = false;
            		}
HXDLIN( 239)		if (_hx_tmp) {
HXLINE( 241)			 ::Dynamic symbol = this->swf->symbols->iterator();
HXDLIN( 241)			while(( (bool)(symbol->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 241)				 ::openfl::_internal::symbols::SWFSymbol symbol1 = ( ( ::openfl::_internal::symbols::SWFSymbol)(symbol->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXLINE( 243)				bool _hx_tmp1;
HXDLIN( 243)				if (::Std_obj::is(symbol1,hx::ClassOf< ::openfl::_internal::symbols::BitmapSymbol >())) {
HXLINE( 243)					_hx_tmp1 = (hx::TCast<  ::openfl::_internal::symbols::BitmapSymbol >::cast(symbol1)->path == id);
            				}
            				else {
HXLINE( 243)					_hx_tmp1 = false;
            				}
HXDLIN( 243)				if (_hx_tmp1) {
HXLINE( 245)					 ::openfl::_internal::symbols::BitmapSymbol bitmapSymbol = ( ( ::openfl::_internal::symbols::BitmapSymbol)(symbol1) );
HXLINE( 247)					if (hx::IsNotNull( bitmapSymbol->alpha )) {
            						...
            						void _hx_run( ::lime::graphics::Image image){
            							...
            							void _hx_run( ::lime::graphics::Image alpha){
            								HX_GC_STACKFRAME(&_hx_pos_f3ab34383ae5e3ff_253_loadImage)
HXLINE( 255)								_gthis->_hx___copyChannel(image,alpha);
HXLINE( 257)								_gthis->cachedImages->set(id,image);
HXLINE( 258)								_gthis->alphaCheck->set(id,true);
HXLINE( 260)								promise->complete(image);
            							}
            							HX_END_LOCAL_FUNC1((void))

            							HX_GC_STACKFRAME(&_hx_pos_f3ab34383ae5e3ff_253_loadImage)
HXLINE( 253)							_gthis->_hx___loadImage(bitmapSymbol->alpha)->onError(promise->error_dyn())->onComplete( ::Dynamic(new _hx_Closure_0(id,_gthis,promise,image)));
            						}
            						HX_END_LOCAL_FUNC1((void))

HXLINE( 249)						 ::lime::app::Promise_lime_graphics_Image promise =  ::lime::app::Promise_lime_graphics_Image_obj::__alloc( HX_CTX );
HXLINE( 251)						this->_hx___loadImage(id)->onError(promise->error_dyn())->onComplete( ::Dynamic(new _hx_Closure_1(id,_gthis,promise,bitmapSymbol)));
HXLINE( 266)						return promise->future;
            					}
            				}
            			}
            		}
HXLINE( 276)		return this->super::loadImage(id);
            	}


void SWFLiteLibrary_obj::unload(){
            	HX_STACKFRAME(&_hx_pos_f3ab34383ae5e3ff_281_unload)
HXLINE( 283)		 ::openfl::_internal::symbols::BitmapSymbol bitmap;
HXLINE( 285)		{
HXLINE( 285)			 ::Dynamic symbol = this->swf->symbols->iterator();
HXDLIN( 285)			while(( (bool)(symbol->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 285)				 ::openfl::_internal::symbols::SWFSymbol symbol1 = ( ( ::openfl::_internal::symbols::SWFSymbol)(symbol->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXLINE( 287)				if (::Std_obj::is(symbol1,hx::ClassOf< ::openfl::_internal::symbols::BitmapSymbol >())) {
HXLINE( 289)					bitmap = ( ( ::openfl::_internal::symbols::BitmapSymbol)(symbol1) );
HXLINE( 290)					::openfl::utils::IAssetCache_obj::removeBitmapData(::openfl::utils::Assets_obj::cache,bitmap->path);
            				}
            			}
            		}
            	}
...
void SWFLiteLibrary_obj::_hx___copyChannel( ::lime::graphics::Image image, ::lime::graphics::Image alpha){
            	HX_GC_STACKFRAME(&_hx_pos_f3ab34383ae5e3ff_299___copyChannel)
HXLINE( 301)		if (hx::IsNotNull( alpha )) {
HXLINE( 303)			 ::lime::math::Rectangle _hx_tmp = alpha->get_rect();
HXDLIN( 303)			image->copyChannel(alpha,_hx_tmp, ::lime::math::Vector2_obj::__alloc( HX_CTX ,null(),null()),::lime::graphics::ImageChannel_obj::RED_dyn(),::lime::graphics::ImageChannel_obj::ALPHA_dyn());
            		}
HXLINE( 307)		image->buffer->premultiplied = true;
            	}
...
void SWFLiteLibrary_obj::_hx___fromManifest( ::lime::utils::AssetManifest manifest){
            	HX_STACKFRAME(&_hx_pos_f3ab34383ae5e3ff_316___fromManifest)
HXLINE( 318)		this->rootPath = manifest->rootPath;
HXLINE( 319)		this->super::_hx___fromManifest(manifest);
            	}


 ::lime::app::Future SWFLiteLibrary_obj::_hx___load(){
            	HX_STACKFRAME(&_hx_pos_f3ab34383ae5e3ff_326___load)
HXDLIN( 326)		return this->super::load();
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(SWFLiteLibrary_obj,_hx___load,return )
 ...
 ::lime::app::Future SWFLiteLibrary_obj::_hx___loadImage(::String id){
            	HX_STACKFRAME(&_hx_pos_f3ab34383ae5e3ff_333___loadImage)
HXDLIN( 333)		return this->super::loadImage(id);
            	}
