...
HX_DECLARE_STACK_FRAME(_hx_pos_3b7a66bddb205621_832_new)
...
HXLINE( 834)		( ( ::lime::_backend::native::_NativeApplication::GamepadEventInfo)(__this) )->type = type;
HXLINE( 835)		( ( ::lime::_backend::native::_NativeApplication::GamepadEventInfo)(__this) )->id = id;
HXLINE( 836)		( ( ::lime::_backend::native::_NativeApplication::GamepadEventInfo)(__this) )->button = button;
HXLINE( 837)		( ( ::lime::_backend::native::_NativeApplication::GamepadEventInfo)(__this) )->axis = axis;
HXLINE( 838)		( ( ::lime::_backend::native::_NativeApplication::GamepadEventInfo)(__this) )->value = value;
            	}
