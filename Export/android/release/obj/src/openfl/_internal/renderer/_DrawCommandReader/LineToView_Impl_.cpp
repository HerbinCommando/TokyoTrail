...
HX_LOCAL_STACK_FRAME(_hx_pos_0768e4473d6cced6_396__new,"openfl._internal.renderer._DrawCommandReader.LineToView_Impl_","_new",0xdb6ba453,"openfl._internal.renderer._DrawCommandReader.LineToView_Impl_._new","openfl/_internal/renderer/DrawCommandReader.hx",396,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_0768e4473d6cced6_397_get_x,"openfl._internal.renderer._DrawCommandReader.LineToView_Impl_","get_x",0xb8112a1d,"openfl._internal.renderer._DrawCommandReader.LineToView_Impl_.get_x","openfl/_internal/renderer/DrawCommandReader.hx",397,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_0768e4473d6cced6_398_get_y,"openfl._internal.renderer._DrawCommandReader.LineToView_Impl_","get_y",0xb8112a1e,"openfl._internal.renderer._DrawCommandReader.LineToView_Impl_.get_y","openfl/_internal/renderer/DrawCommandReader.hx",398,0xbbdbd1ae)
namespace openfl{
namespace _internal{
namespace renderer{
...
bool LineToView_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::_internal::renderer::DrawCommandReader LineToView_Impl__obj::_new( ::openfl::_internal::renderer::DrawCommandReader d){
            	HX_STACKFRAME(&_hx_pos_0768e4473d6cced6_396__new)
HXDLIN( 396)		 ::openfl::_internal::renderer::DrawCommandReader this1 = d;
...
Float LineToView_Impl__obj::get_x( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_0768e4473d6cced6_397_get_x)
HXDLIN( 397)		return this1->buffer->f->__get(this1->fPos);
            	}
...
Float LineToView_Impl__obj::get_y( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_0768e4473d6cced6_398_get_y)
HXDLIN( 398)		::Array< Float > this2 = this1->buffer->f;
HXDLIN( 398)		return this2->__get((this1->fPos + (int)1));
            	}
