...
HX_DEFINE_STACK_FRAME(_hx_pos_ca97c355311e00fd_1366_new,"lime.graphics.utils._ImageDataUtil.ImageDataView","new",0xaa0478bd,"lime.graphics.utils._ImageDataUtil.ImageDataView.new","lime/graphics/utils/ImageDataUtil.hx",1366,0x494d921f)
HX_LOCAL_STACK_FRAME(_hx_pos_ca97c355311e00fd_1397_clip,"lime.graphics.utils._ImageDataUtil.ImageDataView","clip",0x12a517d3,"lime.graphics.utils._ImageDataUtil.ImageDataView.clip","lime/graphics/utils/ImageDataUtil.hx",1397,0x494d921f)
HX_LOCAL_STACK_FRAME(_hx_pos_ca97c355311e00fd_1412_row,"lime.graphics.utils._ImageDataUtil.ImageDataView","row",0xaa078a77,"lime.graphics.utils._ImageDataUtil.ImageDataView.row","lime/graphics/utils/ImageDataUtil.hx",1412,0x494d921f)
namespace lime{
namespace graphics{
namespace utils{
...
void ImageDataView_obj::__construct( ::lime::graphics::Image image, ::lime::math::Rectangle rect){
            	HX_STACKFRAME(&_hx_pos_ca97c355311e00fd_1366_new)
HXLINE(1368)		this->image = image;
HXLINE(1370)		if (hx::IsNull( rect )) {
HXLINE(1372)			this->rect = image->get_rect();
            		}
            		else {
HXLINE(1376)			if ((rect->x < (int)0)) {
HXLINE(1376)				rect->x = (int)0;
            			}
HXLINE(1377)			if ((rect->y < (int)0)) {
HXLINE(1377)				rect->y = (int)0;
            			}
HXLINE(1378)			if (((rect->x + rect->width) > image->width)) {
HXLINE(1378)				rect->width = (image->width - rect->x);
            			}
HXLINE(1379)			if (((rect->y + rect->height) > image->height)) {
HXLINE(1379)				rect->height = (image->height - rect->y);
            			}
HXLINE(1380)			if ((rect->width < (int)0)) {
HXLINE(1380)				rect->width = (int)0;
            			}
HXLINE(1381)			if ((rect->height < (int)0)) {
HXLINE(1381)				rect->height = (int)0;
            			}
HXLINE(1382)			this->rect = rect;
            		}
HXLINE(1386)		this->stride = image->buffer->get_stride();
HXLINE(1388)		this->x = ::Math_obj::ceil(this->rect->x);
HXLINE(1389)		this->y = ::Math_obj::ceil(this->rect->y);
HXLINE(1390)		this->width = ::Math_obj::floor(this->rect->width);
HXLINE(1391)		this->height = ::Math_obj::floor(this->rect->height);
HXLINE(1392)		int _hx_tmp = this->stride;
HXDLIN(1392)		int _hx_tmp1 = (_hx_tmp * (this->y + image->offsetY));
HXDLIN(1392)		this->offset = (_hx_tmp1 + ((this->x + image->offsetX) * (int)4));
            	}
...
void ImageDataView_obj::clip(int x,int y,int width,int height){
            	HX_STACKFRAME(&_hx_pos_ca97c355311e00fd_1397_clip)
HXLINE(1399)		this->rect->_hx___contract(x,y,width,height);
HXLINE(1401)		this->x = ::Math_obj::ceil(this->rect->x);
HXLINE(1402)		this->y = ::Math_obj::ceil(this->rect->y);
HXLINE(1403)		this->width = ::Math_obj::floor(this->rect->width);
HXLINE(1404)		this->height = ::Math_obj::floor(this->rect->height);
HXLINE(1405)		int _hx_tmp = this->stride;
HXDLIN(1405)		int _hx_tmp1 = (_hx_tmp * (this->y + this->image->offsetY));
HXDLIN(1405)		this->offset = (_hx_tmp1 + ((this->x + this->image->offsetX) * (int)4));
            	}
...
int ImageDataView_obj::row(int y){
            	HX_STACKFRAME(&_hx_pos_ca97c355311e00fd_1412_row)
HXDLIN(1412)		int _hx_tmp = this->offset;
HXDLIN(1412)		return (_hx_tmp + (this->stride * y));
            	}
