...
static hx::StorageInfo Event_obj_sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::events::IEventDispatcher*/ ,(int)offsetof(Event_obj,currentTarget),HX_HCSTRING("currentTarget","\x6a","\x74","\x49","\x6a")},
	{hx::fsInt,(int)offsetof(Event_obj,eventPhase),HX_HCSTRING("eventPhase","\xc1","\x31","\x44","\x3e")},
	{hx::fsObject /*::openfl::events::IEventDispatcher*/ ,(int)offsetof(Event_obj,target),HX_HCSTRING("target","\x51","\xf3","\xec","\x86")},
