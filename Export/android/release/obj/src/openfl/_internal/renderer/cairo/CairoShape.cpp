...
HXLINE(  34)				renderSession->maskManager->pushObject(shape,null());
HXLINE(  36)				 ::lime::graphics::cairo::Cairo cairo = renderSession->cairo;
HXLINE(  38)				if (renderSession->roundPixels) {
HXLINE(  40)					 ::lime::math::Matrix3 matrix = graphics->_hx___worldTransform->_hx___toMatrix3();
...
HXLINE(  47)					cairo->set_matrix(graphics->_hx___worldTransform->_hx___toMatrix3());
            				}
HXLINE(  51)				cairo->setSourceSurface(graphics->_hx___cairo->get_target(),(int)0,(int)0);
HXLINE(  52)				cairo->paintWithAlpha(shape->_hx___worldAlpha);
HXLINE(  54)				renderSession->maskManager->popObject(shape,null());
            			}
            		}
            	}
