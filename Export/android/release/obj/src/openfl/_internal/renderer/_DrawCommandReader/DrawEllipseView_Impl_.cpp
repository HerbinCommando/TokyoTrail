...
HX_LOCAL_STACK_FRAME(_hx_pos_781ff9dda627132a_302__new,"openfl._internal.renderer._DrawCommandReader.DrawEllipseView_Impl_","_new",0xc710ba18,"openfl._internal.renderer._DrawCommandReader.DrawEllipseView_Impl_._new","openfl/_internal/renderer/DrawCommandReader.hx",302,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_781ff9dda627132a_303_get_x,"openfl._internal.renderer._DrawCommandReader.DrawEllipseView_Impl_","get_x",0xfcdf20b8,"openfl._internal.renderer._DrawCommandReader.DrawEllipseView_Impl_.get_x","openfl/_internal/renderer/DrawCommandReader.hx",303,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_781ff9dda627132a_304_get_y,"openfl._internal.renderer._DrawCommandReader.DrawEllipseView_Impl_","get_y",0xfcdf20b9,"openfl._internal.renderer._DrawCommandReader.DrawEllipseView_Impl_.get_y","openfl/_internal/renderer/DrawCommandReader.hx",304,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_781ff9dda627132a_305_get_width,"openfl._internal.renderer._DrawCommandReader.DrawEllipseView_Impl_","get_width",0xcef6f646,"openfl._internal.renderer._DrawCommandReader.DrawEllipseView_Impl_.get_width","openfl/_internal/renderer/DrawCommandReader.hx",305,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_781ff9dda627132a_306_get_height,"openfl._internal.renderer._DrawCommandReader.DrawEllipseView_Impl_","get_height",0xff6fffa7,"openfl._internal.renderer._DrawCommandReader.DrawEllipseView_Impl_.get_height","openfl/_internal/renderer/DrawCommandReader.hx",306,0xbbdbd1ae)
namespace openfl{
namespace _internal{
namespace renderer{
...
bool DrawEllipseView_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::_internal::renderer::DrawCommandReader DrawEllipseView_Impl__obj::_new( ::openfl::_internal::renderer::DrawCommandReader d){
            	HX_STACKFRAME(&_hx_pos_781ff9dda627132a_302__new)
HXDLIN( 302)		 ::openfl::_internal::renderer::DrawCommandReader this1 = d;
...
Float DrawEllipseView_Impl__obj::get_x( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_781ff9dda627132a_303_get_x)
HXDLIN( 303)		return this1->buffer->f->__get(this1->fPos);
            	}
...
Float DrawEllipseView_Impl__obj::get_y( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_781ff9dda627132a_304_get_y)
HXDLIN( 304)		::Array< Float > this2 = this1->buffer->f;
HXDLIN( 304)		return this2->__get((this1->fPos + (int)1));
            	}
...
Float DrawEllipseView_Impl__obj::get_width( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_781ff9dda627132a_305_get_width)
HXDLIN( 305)		::Array< Float > this2 = this1->buffer->f;
HXDLIN( 305)		return this2->__get((this1->fPos + (int)2));
            	}
...
Float DrawEllipseView_Impl__obj::get_height( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_781ff9dda627132a_306_get_height)
HXDLIN( 306)		::Array< Float > this2 = this1->buffer->f;
HXDLIN( 306)		return this2->__get((this1->fPos + (int)3));
            	}
