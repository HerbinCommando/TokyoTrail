...
HX_DECLARE_STACK_FRAME(_hx_pos_f21a6c5ad88a2e71_6_new)
...
HXLINE(  10)		( ( ::lime::graphics::opengl::ext::ANGLE_texture_usage)(__this) )->FRAMEBUFFER_ATTACHMENT_ANGLE = (int)37795;
HXLINE(   9)		( ( ::lime::graphics::opengl::ext::ANGLE_texture_usage)(__this) )->TEXTURE_USAGE_ANGLE = (int)37794;
            	}
