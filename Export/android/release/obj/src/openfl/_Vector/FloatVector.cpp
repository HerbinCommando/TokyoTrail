...
HX_DEFINE_STACK_FRAME(_hx_pos_055b1e986ae1a23a_594_new,"openfl._Vector.FloatVector","new",0x7ccdf307,"openfl._Vector.FloatVector.new","openfl/Vector.hx",594,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_055b1e986ae1a23a_617_concat,"openfl._Vector.FloatVector","concat",0xbb39c8cd,"openfl._Vector.FloatVector.concat","openfl/Vector.hx",617,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_055b1e986ae1a23a_632_copy,"openfl._Vector.FloatVector","copy",0xb028eb2e,"openfl._Vector.FloatVector.copy","openfl/Vector.hx",632,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_055b1e986ae1a23a_639_get,"openfl._Vector.FloatVector","get",0x7cc8a33d,"openfl._Vector.FloatVector.get","openfl/Vector.hx",639,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_055b1e986ae1a23a_644_indexOf,"openfl._Vector.FloatVector","indexOf",0xe9dd4af0,"openfl._Vector.FloatVector.indexOf","openfl/Vector.hx",644,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_055b1e986ae1a23a_663_insertAt,"openfl._Vector.FloatVector","insertAt",0xb3435c85,"openfl._Vector.FloatVector.insertAt","openfl/Vector.hx",663,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_055b1e986ae1a23a_674_iterator,"openfl._Vector.FloatVector","iterator",0x84be29e7,"openfl._Vector.FloatVector.iterator","openfl/Vector.hx",674,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_055b1e986ae1a23a_681_join,"openfl._Vector.FloatVector","join",0xb4c96363,"openfl._Vector.FloatVector.join","openfl/Vector.hx",681,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_055b1e986ae1a23a_686_lastIndexOf,"openfl._Vector.FloatVector","lastIndexOf",0xc7529eba,"openfl._Vector.FloatVector.lastIndexOf","openfl/Vector.hx",686,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_055b1e986ae1a23a_704_pop,"openfl._Vector.FloatVector","pop",0x7ccf8038,"openfl._Vector.FloatVector.pop","openfl/Vector.hx",704,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_055b1e986ae1a23a_719_push,"openfl._Vector.FloatVector","push",0xb8c54153,"openfl._Vector.FloatVector.push","openfl/Vector.hx",719,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_055b1e986ae1a23a_732_reverse,"openfl._Vector.FloatVector","reverse",0x241a3b49,"openfl._Vector.FloatVector.reverse","openfl/Vector.hx",732,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_055b1e986ae1a23a_742_set,"openfl._Vector.FloatVector","set",0x7cd1be49,"openfl._Vector.FloatVector.set","openfl/Vector.hx",742,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_055b1e986ae1a23a_757_shift,"openfl._Vector.FloatVector","shift",0xa56846e9,"openfl._Vector.FloatVector.shift","openfl/Vector.hx",757,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_055b1e986ae1a23a_772_slice,"openfl._Vector.FloatVector","slice",0xa80d1eb9,"openfl._Vector.FloatVector.slice","openfl/Vector.hx",772,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_055b1e986ae1a23a_779_sort,"openfl._Vector.FloatVector","sort",0xbabc56d7,"openfl._Vector.FloatVector.sort","openfl/Vector.hx",779,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_055b1e986ae1a23a_786_splice,"openfl._Vector.FloatVector","splice",0xb3084535,"openfl._Vector.FloatVector.splice","openfl/Vector.hx",786,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_055b1e986ae1a23a_793_toString,"openfl._Vector.FloatVector","toString",0x2992b0a5,"openfl._Vector.FloatVector.toString","openfl/Vector.hx",793,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_055b1e986ae1a23a_800_unshift,"openfl._Vector.FloatVector","unshift",0x81d1e5b0,"openfl._Vector.FloatVector.unshift","openfl/Vector.hx",800,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_055b1e986ae1a23a_818_get_length,"openfl._Vector.FloatVector","get_length",0xf96594e8,"openfl._Vector.FloatVector.get_length","openfl/Vector.hx",818,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_055b1e986ae1a23a_823_set_length,"openfl._Vector.FloatVector","set_length",0xfce3335c,"openfl._Vector.FloatVector.set_length","openfl/Vector.hx",823,0x4a01873c)
namespace openfl{
namespace _Vector{

void FloatVector_obj::__construct( ::Dynamic length, ::Dynamic fixed,::Array< Float > array){
            	HX_STACKFRAME(&_hx_pos_055b1e986ae1a23a_594_new)
HXLINE( 596)		if (hx::IsNull( array )) {
HXLINE( 598)			array = ::Array_obj< Float >::__new();
            		}
HXLINE( 602)		this->_hx___array = array;
HXLINE( 604)		if (hx::IsNotNull( length )) {
HXLINE( 606)			this->set_length(length);
            		}
HXLINE( 610)		this->fixed = hx::IsEq( fixed,true );
            	}
...
::Dynamic FloatVector_obj::concat(::Dynamic a){
            	HX_GC_STACKFRAME(&_hx_pos_055b1e986ae1a23a_617_concat)
HXDLIN( 617)		if (hx::IsNull( a )) {
HXLINE( 619)			return  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,null(),null(),this->_hx___array->copy());
            		}
            		else {
HXLINE( 623)			::Array< Float > _hx_tmp = this->_hx___array;
HXDLIN( 623)			return  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,null(),null(),_hx_tmp->concat(hx::TCast<  ::openfl::_Vector::FloatVector >::cast(a)->_hx___array));
            		}
...
::Dynamic FloatVector_obj::copy(){
            	HX_GC_STACKFRAME(&_hx_pos_055b1e986ae1a23a_632_copy)
HXDLIN( 632)		bool _hx_tmp = this->fixed;
HXDLIN( 632)		return  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,null(),_hx_tmp,this->_hx___array->copy());
            	}
...
Float FloatVector_obj::get(int index){
            	HX_STACKFRAME(&_hx_pos_055b1e986ae1a23a_639_get)
HXDLIN( 639)		return this->_hx___array->__get(index);
            	}
...
int FloatVector_obj::indexOf(Float x, ::Dynamic __o_from){
 ::Dynamic from = __o_from.Default(0);
            	HX_STACKFRAME(&_hx_pos_055b1e986ae1a23a_644_indexOf)
HXLINE( 646)		{
HXLINE( 646)			int _g1 = from;
HXDLIN( 646)			int _g = this->_hx___array->length;
HXDLIN( 646)			while((_g1 < _g)){
HXLINE( 646)				_g1 = (_g1 + (int)1);
HXDLIN( 646)				int i = (_g1 - (int)1);
HXLINE( 648)				if ((this->_hx___array->__get(i) == x)) {
HXLINE( 650)					return i;
            				}
            			}
            		}
...
void FloatVector_obj::insertAt(int index,Float element){
            	HX_STACKFRAME(&_hx_pos_055b1e986ae1a23a_663_insertAt)
HXDLIN( 663)		bool _hx_tmp;
HXDLIN( 663)		if (!(!(this->fixed))) {
HXDLIN( 663)			_hx_tmp = (index < this->_hx___array->length);
            		}
            		else {
HXDLIN( 663)			_hx_tmp = true;
            		}
HXDLIN( 663)		if (_hx_tmp) {
HXLINE( 665)			this->_hx___array->insert(index,element);
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(FloatVector_obj,insertAt,(void))
 ...
 ::Dynamic FloatVector_obj::iterator(){
            	HX_STACKFRAME(&_hx_pos_055b1e986ae1a23a_674_iterator)
HXDLIN( 674)		return this->_hx___array->iterator();
            	}
...
::String FloatVector_obj::join(::String sep){
            	HX_STACKFRAME(&_hx_pos_055b1e986ae1a23a_681_join)
HXDLIN( 681)		return this->_hx___array->join(sep);
            	}
...
int FloatVector_obj::lastIndexOf(Float x, ::Dynamic __o_from){
 ::Dynamic from = __o_from.Default(0);
            	HX_STACKFRAME(&_hx_pos_055b1e986ae1a23a_686_lastIndexOf)
HXLINE( 688)		int i = (this->_hx___array->length - (int)1);
HXLINE( 690)		while(hx::IsGreaterEq( i,from )){
HXLINE( 692)			if ((this->_hx___array->__get(i) == x)) {
HXLINE( 692)				return i;
            			}
HXLINE( 693)			i = (i - (int)1);
            		}
...
HX_DEFINE_DYNAMIC_FUNC2(FloatVector_obj,lastIndexOf,return )
 ...
 ::Dynamic FloatVector_obj::pop(){
            	HX_STACKFRAME(&_hx_pos_055b1e986ae1a23a_704_pop)
HXDLIN( 704)		if (!(this->fixed)) {
HXLINE( 706)			return this->_hx___array->pop();
            		}
            		else {
...
int FloatVector_obj::push(Float x){
            	HX_STACKFRAME(&_hx_pos_055b1e986ae1a23a_719_push)
HXDLIN( 719)		if (!(this->fixed)) {
HXLINE( 721)			return this->_hx___array->push(x);
            		}
            		else {
HXLINE( 725)			return this->_hx___array->length;
            		}
...
::Dynamic FloatVector_obj::reverse(){
            	HX_STACKFRAME(&_hx_pos_055b1e986ae1a23a_732_reverse)
HXLINE( 734)		this->_hx___array->reverse();
HXLINE( 735)		return hx::ObjectPtr<OBJ_>(this);
            	}
...
Float FloatVector_obj::set(int index,Float value){
            	HX_STACKFRAME(&_hx_pos_055b1e986ae1a23a_742_set)
HXDLIN( 742)		bool _hx_tmp;
HXDLIN( 742)		if (!(!(this->fixed))) {
HXDLIN( 742)			_hx_tmp = (index < this->_hx___array->length);
            		}
            		else {
HXDLIN( 742)			_hx_tmp = true;
            		}
HXDLIN( 742)		if (_hx_tmp) {
HXLINE( 744)			return (this->_hx___array[index] = value);
            		}
            		else {
HXLINE( 748)			return value;
            		}
HXLINE( 742)		return ((Float)0.);
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(FloatVector_obj,set,return )
 ...
 ::Dynamic FloatVector_obj::shift(){
            	HX_STACKFRAME(&_hx_pos_055b1e986ae1a23a_757_shift)
HXDLIN( 757)		if (!(this->fixed)) {
HXLINE( 759)			return this->_hx___array->shift();
            		}
            		else {
...
::Dynamic FloatVector_obj::slice( ::Dynamic __o_startIndex, ::Dynamic __o_endIndex){
 ...
 ::Dynamic endIndex = __o_endIndex.Default(16777215);
            	HX_GC_STACKFRAME(&_hx_pos_055b1e986ae1a23a_772_slice)
HXDLIN( 772)		return  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,null(),null(),this->_hx___array->slice(startIndex,endIndex));
            	}
...
void FloatVector_obj::sort( ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_055b1e986ae1a23a_779_sort)
HXDLIN( 779)		this->_hx___array->sort(f);
            	}
...
::Dynamic FloatVector_obj::splice(int pos,int len){
            	HX_GC_STACKFRAME(&_hx_pos_055b1e986ae1a23a_786_splice)
HXDLIN( 786)		return  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,null(),null(),this->_hx___array->splice(pos,len));
            	}
...
::String FloatVector_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_055b1e986ae1a23a_793_toString)
HXDLIN( 793)		if (hx::IsNotNull( this->_hx___array )) {
HXDLIN( 793)			return this->_hx___array->toString();
            		}
            		else {
...
void FloatVector_obj::unshift(Float x){
            	HX_STACKFRAME(&_hx_pos_055b1e986ae1a23a_800_unshift)
HXDLIN( 800)		if (!(this->fixed)) {
HXLINE( 802)			this->_hx___array->unshift(x);
            		}
            	}
...
int FloatVector_obj::get_length(){
            	HX_STACKFRAME(&_hx_pos_055b1e986ae1a23a_818_get_length)
HXDLIN( 818)		return this->_hx___array->length;
            	}
...
int FloatVector_obj::set_length(int value){
            	HX_STACKFRAME(&_hx_pos_055b1e986ae1a23a_823_set_length)
HXLINE( 825)		if (!(this->fixed)) {
HXLINE( 829)			_hx_array_set_size_exact(this->_hx___array,value);
            		}
HXLINE( 858)		return this->_hx___array->length;
            	}
