...
HXDLIN( 922)		bool _hx_tmp = this->fixed;
...
HXDLIN( 929)		if ((index >= this->_hx___array->get_length())) {
...
HXDLIN( 961)			_hx_tmp = (index < this->_hx___array->get_length());
            		}
            		else {
...
HXDLIN( 972)		return this->_hx___array->iterator();
            	}
...
HXDLIN( 979)		return this->_hx___array->join(sep);
            	}
...
HXDLIN(1040)		bool _hx_tmp;
HXDLIN(1040)		if (!(!(this->fixed))) {
HXDLIN(1040)			_hx_tmp = (index < this->_hx___array->get_length());
            		}
            		else {
HXDLIN(1040)			_hx_tmp = true;
            		}
...
HXDLIN(1070)		return  ::openfl::_Vector::FunctionVector_obj::__alloc( HX_CTX ,null(),null(),this->_hx___array->slice(startIndex,endIndex));
            	}
...
HXDLIN(1077)		this->_hx___array->sort(f);
            	}
...
HXDLIN(1084)		return  ::openfl::_Vector::FunctionVector_obj::__alloc( HX_CTX ,null(),null(),this->_hx___array->splice(pos,len));
            	}
...
HXDLIN(1091)		if (hx::IsNotNull( this->_hx___array )) {
HXDLIN(1091)			return this->_hx___array->toString();
            		}
            		else {
...
HXDLIN(1116)		return this->_hx___array->get_length();
            	}
