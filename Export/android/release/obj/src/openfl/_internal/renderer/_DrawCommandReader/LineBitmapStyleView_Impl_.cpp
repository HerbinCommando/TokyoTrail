...
HX_LOCAL_STACK_FRAME(_hx_pos_3928fbcce9df7715_355__new,"openfl._internal.renderer._DrawCommandReader.LineBitmapStyleView_Impl_","_new",0x6ec636a4,"openfl._internal.renderer._DrawCommandReader.LineBitmapStyleView_Impl_._new","openfl/_internal/renderer/DrawCommandReader.hx",355,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_3928fbcce9df7715_356_get_bitmap,"openfl._internal.renderer._DrawCommandReader.LineBitmapStyleView_Impl_","get_bitmap",0xeee7753b,"openfl._internal.renderer._DrawCommandReader.LineBitmapStyleView_Impl_.get_bitmap","openfl/_internal/renderer/DrawCommandReader.hx",356,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_3928fbcce9df7715_357_get_matrix,"openfl._internal.renderer._DrawCommandReader.LineBitmapStyleView_Impl_","get_matrix",0xb9a39b8d,"openfl._internal.renderer._DrawCommandReader.LineBitmapStyleView_Impl_.get_matrix","openfl/_internal/renderer/DrawCommandReader.hx",357,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_3928fbcce9df7715_358_get_repeat,"openfl._internal.renderer._DrawCommandReader.LineBitmapStyleView_Impl_","get_repeat",0x0457fca7,"openfl._internal.renderer._DrawCommandReader.LineBitmapStyleView_Impl_.get_repeat","openfl/_internal/renderer/DrawCommandReader.hx",358,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_3928fbcce9df7715_359_get_smooth,"openfl._internal.renderer._DrawCommandReader.LineBitmapStyleView_Impl_","get_smooth",0x05466d7a,"openfl._internal.renderer._DrawCommandReader.LineBitmapStyleView_Impl_.get_smooth","openfl/_internal/renderer/DrawCommandReader.hx",359,0xbbdbd1ae)
namespace openfl{
namespace _internal{
namespace renderer{
...
bool LineBitmapStyleView_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::_internal::renderer::DrawCommandReader LineBitmapStyleView_Impl__obj::_new( ::openfl::_internal::renderer::DrawCommandReader d){
            	HX_STACKFRAME(&_hx_pos_3928fbcce9df7715_355__new)
HXDLIN( 355)		 ::openfl::_internal::renderer::DrawCommandReader this1 = d;
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(LineBitmapStyleView_Impl__obj,_new,return )
 ...
 ::openfl::display::BitmapData LineBitmapStyleView_Impl__obj::get_bitmap( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_3928fbcce9df7715_356_get_bitmap)
HXDLIN( 356)		return ( ( ::openfl::display::BitmapData)(this1->buffer->o->__get(this1->oPos)) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(LineBitmapStyleView_Impl__obj,get_bitmap,return )
 ...
 ::openfl::geom::Matrix LineBitmapStyleView_Impl__obj::get_matrix( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_3928fbcce9df7715_357_get_matrix)
HXDLIN( 357)		::cpp::VirtualArray this2 = this1->buffer->o;
HXDLIN( 357)		return ( ( ::openfl::geom::Matrix)(this2->__get((this1->oPos + (int)1))) );
            	}
...
bool LineBitmapStyleView_Impl__obj::get_repeat( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_3928fbcce9df7715_358_get_repeat)
...
bool LineBitmapStyleView_Impl__obj::get_smooth( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_3928fbcce9df7715_359_get_smooth)
HXDLIN( 359)		::Array< bool > this2 = this1->buffer->b;
HXDLIN( 359)		return this2->__get((this1->bPos + (int)1));
            	}
