...
HX_LOCAL_STACK_FRAME(_hx_pos_7545faed7dab6ee1_34_clone,"openfl.filters.ColorMatrixFilter","clone",0x2c5b239a,"openfl.filters.ColorMatrixFilter.clone","openfl/filters/ColorMatrixFilter.hx",34,0xb64128b5)
HX_LOCAL_STACK_FRAME(_hx_pos_7545faed7dab6ee1_39___applyFilter,"openfl.filters.ColorMatrixFilter","__applyFilter",0xffb635e3,"openfl.filters.ColorMatrixFilter.__applyFilter","openfl/filters/ColorMatrixFilter.hx",39,0xb64128b5)
HX_LOCAL_STACK_FRAME(_hx_pos_7545faed7dab6ee1_85___initShader,"openfl.filters.ColorMatrixFilter","__initShader",0x2d28b6d8,"openfl.filters.ColorMatrixFilter.__initShader","openfl/filters/ColorMatrixFilter.hx",85,0xb64128b5)
HX_LOCAL_STACK_FRAME(_hx_pos_7545faed7dab6ee1_100_set_matrix,"openfl.filters.ColorMatrixFilter","set_matrix",0x82603721,"openfl.filters.ColorMatrixFilter.set_matrix","openfl/filters/ColorMatrixFilter.hx",100,0xb64128b5)
...
HXDLIN(  34)		return  ::openfl::filters::ColorMatrixFilter_obj::__alloc( HX_CTX ,this->matrix);
            	}
...
HXLINE(  48)		 ::lime::utils::ArrayBufferView source = sourceBitmapData->image->get_data();
HXLINE(  49)		 ::lime::utils::ArrayBufferView target = destBitmapData->image->get_data();
HXLINE(  51)		int offsetX = ::Std_obj::_hx_int((destPoint->x - sourceRect->x));
HXLINE(  52)		int offsetY = ::Std_obj::_hx_int((destPoint->y - sourceRect->y));
HXLINE(  53)		int sourceStride = (sourceBitmapData->width * (int)4);
HXLINE(  54)		int targetStride = (destBitmapData->width * (int)4);
HXLINE(  56)		int sourceOffset;
HXLINE(  57)		int targetOffset;
HXLINE(  59)		{
HXLINE(  59)			int _g1 = ::Std_obj::_hx_int(sourceRect->y);
HXDLIN(  59)			int _g = ::Std_obj::_hx_int(sourceRect->height);
HXDLIN(  59)			while((_g1 < _g)){
HXLINE(  59)				_g1 = (_g1 + (int)1);
HXDLIN(  59)				int row = (_g1 - (int)1);
HXLINE(  61)				{
HXLINE(  61)					int _g3 = ::Std_obj::_hx_int(sourceRect->x);
HXDLIN(  61)					int _g2 = ::Std_obj::_hx_int(sourceRect->width);
HXDLIN(  61)					while((_g3 < _g2)){
HXLINE(  61)						_g3 = (_g3 + (int)1);
HXDLIN(  61)						int column = (_g3 - (int)1);
HXLINE(  63)						sourceOffset = ((row * sourceStride) + (column * (int)4));
HXLINE(  64)						targetOffset = (((row + offsetX) * targetStride) + ((column + offsetY) * (int)4));
HXLINE(  66)						 ::Dynamic srcR = ((int)::__hxcpp_memory_get_byte(source->buffer->b,(source->byteOffset + sourceOffset)) & (int)(int)255);
HXLINE(  67)						int source1 = source->byteOffset;
HXDLIN(  67)						 ::Dynamic srcG = ((int)::__hxcpp_memory_get_byte(source->buffer->b,(source1 + (sourceOffset + (int)1))) & (int)(int)255);
HXLINE(  68)						int source2 = source->byteOffset;
HXDLIN(  68)						 ::Dynamic srcB = ((int)::__hxcpp_memory_get_byte(source->buffer->b,(source2 + (sourceOffset + (int)2))) & (int)(int)255);
HXLINE(  69)						int source3 = source->byteOffset;
HXDLIN(  69)						 ::Dynamic srcA = ((int)::__hxcpp_memory_get_byte(source->buffer->b,(source3 + (sourceOffset + (int)3))) & (int)(int)255);
HXLINE(  71)						{
HXLINE(  71)							int _hx_int = srcR;
HXDLIN(  71)							Float val;
...
HXDLIN(  71)							Float val4 = ((((val * this->matrix->__get((int)0)) + (val1 * this->matrix->__get((int)1))) + (val2 * this->matrix->__get((int)2))) + (val3 * this->matrix->__get((int)3)));
HXDLIN(  71)							int val5 = ::Std_obj::_hx_int((val4 + this->matrix->__get((int)4)));
HXDLIN(  71)							::__hxcpp_memory_set_byte(target->buffer->b,(target->byteOffset + targetOffset),val5);
            						}
HXLINE(  72)						{
HXLINE(  72)							int int4 = srcR;
HXDLIN(  72)							Float val6;
HXDLIN(  72)							if ((int4 < (int)0)) {
HXLINE(  72)								val6 = (((Float)4294967296.0) + int4);
            							}
            							else {
HXLINE(  72)								val6 = (int4 + ((Float)0.0));
            							}
HXDLIN(  72)							int int5 = srcG;
HXDLIN(  72)							Float val7;
HXDLIN(  72)							if ((int5 < (int)0)) {
HXLINE(  72)								val7 = (((Float)4294967296.0) + int5);
            							}
            							else {
HXLINE(  72)								val7 = (int5 + ((Float)0.0));
            							}
HXDLIN(  72)							int int6 = srcB;
HXDLIN(  72)							Float val8;
HXDLIN(  72)							if ((int6 < (int)0)) {
HXLINE(  72)								val8 = (((Float)4294967296.0) + int6);
            							}
            							else {
HXLINE(  72)								val8 = (int6 + ((Float)0.0));
            							}
HXDLIN(  72)							int int7 = srcA;
HXDLIN(  72)							Float val9;
HXDLIN(  72)							if ((int7 < (int)0)) {
HXLINE(  72)								val9 = (((Float)4294967296.0) + int7);
            							}
            							else {
HXLINE(  72)								val9 = (int7 + ((Float)0.0));
            							}
HXDLIN(  72)							Float val10 = ((((val6 * this->matrix->__get((int)5)) + (val7 * this->matrix->__get((int)6))) + (val8 * this->matrix->__get((int)7))) + (val9 * this->matrix->__get((int)8)));
HXDLIN(  72)							int val11 = ::Std_obj::_hx_int((val10 + this->matrix->__get((int)9)));
HXDLIN(  72)							{
HXLINE(  72)								int target1 = target->byteOffset;
HXDLIN(  72)								::__hxcpp_memory_set_byte(target->buffer->b,(target1 + (targetOffset + (int)1)),val11);
            							}
            						}
HXLINE(  73)						{
HXLINE(  73)							int int8 = srcR;
HXDLIN(  73)							Float val12;
HXDLIN(  73)							if ((int8 < (int)0)) {
HXLINE(  73)								val12 = (((Float)4294967296.0) + int8);
            							}
            							else {
HXLINE(  73)								val12 = (int8 + ((Float)0.0));
            							}
HXDLIN(  73)							int int9 = srcG;
HXDLIN(  73)							Float val13;
HXDLIN(  73)							if ((int9 < (int)0)) {
HXLINE(  73)								val13 = (((Float)4294967296.0) + int9);
            							}
            							else {
HXLINE(  73)								val13 = (int9 + ((Float)0.0));
            							}
HXDLIN(  73)							int int10 = srcB;
HXDLIN(  73)							Float val14;
HXDLIN(  73)							if ((int10 < (int)0)) {
HXLINE(  73)								val14 = (((Float)4294967296.0) + int10);
            							}
            							else {
HXLINE(  73)								val14 = (int10 + ((Float)0.0));
            							}
HXDLIN(  73)							int int11 = srcA;
HXDLIN(  73)							Float val15;
HXDLIN(  73)							if ((int11 < (int)0)) {
HXLINE(  73)								val15 = (((Float)4294967296.0) + int11);
            							}
            							else {
HXLINE(  73)								val15 = (int11 + ((Float)0.0));
            							}
HXDLIN(  73)							Float val16 = ((((val12 * this->matrix->__get((int)10)) + (val13 * this->matrix->__get((int)11))) + (val14 * this->matrix->__get((int)12))) + (val15 * this->matrix->__get((int)13)));
HXDLIN(  73)							int val17 = ::Std_obj::_hx_int((val16 + this->matrix->__get((int)14)));
HXDLIN(  73)							{
HXLINE(  73)								int target2 = target->byteOffset;
HXDLIN(  73)								::__hxcpp_memory_set_byte(target->buffer->b,(target2 + (targetOffset + (int)2)),val17);
            							}
            						}
HXLINE(  74)						{
HXLINE(  74)							int int12 = srcR;
HXDLIN(  74)							Float val18;
HXDLIN(  74)							if ((int12 < (int)0)) {
HXLINE(  74)								val18 = (((Float)4294967296.0) + int12);
            							}
            							else {
HXLINE(  74)								val18 = (int12 + ((Float)0.0));
            							}
HXDLIN(  74)							int int13 = srcG;
HXDLIN(  74)							Float val19;
HXDLIN(  74)							if ((int13 < (int)0)) {
HXLINE(  74)								val19 = (((Float)4294967296.0) + int13);
            							}
            							else {
HXLINE(  74)								val19 = (int13 + ((Float)0.0));
            							}
HXDLIN(  74)							int int14 = srcB;
HXDLIN(  74)							Float val20;
HXDLIN(  74)							if ((int14 < (int)0)) {
HXLINE(  74)								val20 = (((Float)4294967296.0) + int14);
            							}
            							else {
HXLINE(  74)								val20 = (int14 + ((Float)0.0));
            							}
HXDLIN(  74)							int int15 = srcA;
HXDLIN(  74)							Float val21;
HXDLIN(  74)							if ((int15 < (int)0)) {
HXLINE(  74)								val21 = (((Float)4294967296.0) + int15);
            							}
            							else {
HXLINE(  74)								val21 = (int15 + ((Float)0.0));
            							}
HXDLIN(  74)							Float val22 = ((((val18 * this->matrix->__get((int)15)) + (val19 * this->matrix->__get((int)16))) + (val20 * this->matrix->__get((int)17))) + (val21 * this->matrix->__get((int)18)));
HXDLIN(  74)							int val23 = ::Std_obj::_hx_int((val22 + this->matrix->__get((int)19)));
HXDLIN(  74)							{
HXLINE(  74)								int target3 = target->byteOffset;
HXDLIN(  74)								::__hxcpp_memory_set_byte(target->buffer->b,(target3 + (targetOffset + (int)3)),val23);
            							}
            						}
            					}
            				}
