...
HX_DECLARE_STACK_FRAME(_hx_pos_afd93a4eedeb9e3f_1118_new)
...
HXLINE(1120)		( ( ::lime::_backend::native::_NativeApplication::TouchEventInfo)(__this) )->type = type;
HXLINE(1121)		( ( ::lime::_backend::native::_NativeApplication::TouchEventInfo)(__this) )->x = x;
HXLINE(1122)		( ( ::lime::_backend::native::_NativeApplication::TouchEventInfo)(__this) )->y = y;
HXLINE(1123)		( ( ::lime::_backend::native::_NativeApplication::TouchEventInfo)(__this) )->id = id;
HXLINE(1124)		( ( ::lime::_backend::native::_NativeApplication::TouchEventInfo)(__this) )->dx = dx;
HXLINE(1125)		( ( ::lime::_backend::native::_NativeApplication::TouchEventInfo)(__this) )->dy = dy;
HXLINE(1126)		( ( ::lime::_backend::native::_NativeApplication::TouchEventInfo)(__this) )->pressure = pressure;
HXLINE(1127)		( ( ::lime::_backend::native::_NativeApplication::TouchEventInfo)(__this) )->device = device;
            	}
