...
HXDLIN(  45)		return  ::openfl::filters::DropShadowFilter_obj::__alloc( HX_CTX ,this->distance,this->angle,this->color,this->alpha,this->blurX,this->blurY,this->strength,this->quality,this->inner,this->knockout,this->hideObject);
            	}


bool DropShadowFilter_obj::set_knockout(bool value){
            	HX_STACKFRAME(&_hx_pos_786269b8d678908e_59_set_knockout)
HXDLIN(  59)		return (this->knockout = value);
            	}
...
HXDLIN(  66)		return (this->hideObject = value);
            	}
...
HXDLIN(  73)		return (this->quality = value);
            	}
