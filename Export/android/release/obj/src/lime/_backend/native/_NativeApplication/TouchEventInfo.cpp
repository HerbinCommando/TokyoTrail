...
HX_DEFINE_STACK_FRAME(_hx_pos_afd93a4eedeb9e3f_1118_new,"lime._backend.native._NativeApplication.TouchEventInfo","new",0x974ae818,"lime._backend.native._NativeApplication.TouchEventInfo.new","lime/_backend/native/NativeApplication.hx",1118,0xb13849fd)
HX_LOCAL_STACK_FRAME(_hx_pos_afd93a4eedeb9e3f_1134_clone,"lime._backend.native._NativeApplication.TouchEventInfo","clone",0xdd198915,"lime._backend.native._NativeApplication.TouchEventInfo.clone","lime/_backend/native/NativeApplication.hx",1134,0xb13849fd)
namespace lime{
namespace _backend{
namespace native{
...
int device = __o_device.Default(0);
            	HX_STACKFRAME(&_hx_pos_afd93a4eedeb9e3f_1118_new)
HXLINE(1120)		this->type = type;
HXLINE(1121)		this->x = x;
HXLINE(1122)		this->y = y;
HXLINE(1123)		this->id = id;
HXLINE(1124)		this->dx = dx;
HXLINE(1125)		this->dy = dy;
HXLINE(1126)		this->pressure = pressure;
HXLINE(1127)		this->device = device;
            	}
...
bool TouchEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_backend::native::_NativeApplication::TouchEventInfo TouchEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_afd93a4eedeb9e3f_1134_clone)
HXDLIN(1134)		return  ::lime::_backend::native::_NativeApplication::TouchEventInfo_obj::__alloc( HX_CTX ,this->type,this->x,this->y,this->id,this->dx,this->dy,this->pressure,this->device);
            	}
