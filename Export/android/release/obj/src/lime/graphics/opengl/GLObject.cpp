...
HX_DEFINE_STACK_FRAME(_hx_pos_def54b8cacb52d8e_3135_new,"lime.graphics.opengl.GLObject","new",0x33d200eb,"lime.graphics.opengl.GLObject.new","lime/graphics/opengl/GL.hx",3135,0xa5aa2623)
HX_LOCAL_STACK_FRAME(_hx_pos_def54b8cacb52d8e_3140_fromInt,"lime.graphics.opengl.GLObject","fromInt",0x6703afb0,"lime.graphics.opengl.GLObject.fromInt","lime/graphics/opengl/GL.hx",3140,0xa5aa2623)
namespace lime{
namespace graphics{
namespace opengl{

void GLObject_obj::__construct(int id){
            	HX_STACKFRAME(&_hx_pos_def54b8cacb52d8e_3135_new)
HXDLIN(3135)		this->id = id;
            	}
...
bool GLObject_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::graphics::opengl::GLObject GLObject_obj::fromInt(int type,int id){
            	HX_GC_STACKFRAME(&_hx_pos_def54b8cacb52d8e_3140_fromInt)
HXLINE(3142)		if ((id == (int)0)) {
HXLINE(3142)			return null();
            		}
HXLINE(3145)		 ::hx::Object * object = ::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_object_from_id(id,type);
HXLINE(3147)		if (hx::IsNotEq( object,hx::DynamicPtr(null()) )) {
HXLINE(3149)			return ( ( ::Dynamic)(object) );
            		}
HXLINE(3153)		object = hx::DynamicPtr( ::lime::graphics::opengl::GLObject_obj::__alloc( HX_CTX ,id));
HXLINE(3154)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_object_register(id,type,object);
HXLINE(3155)		return ( ( ::Dynamic)(object) );
            	}
