...
HX_LOCAL_STACK_FRAME(_hx_pos_d75712e93d25d4a6_1394_boot,"openfl.display3D._Context3D.Context3DTelemetry_Impl_","boot",0xa804c893,"openfl.display3D._Context3D.Context3DTelemetry_Impl_.boot","openfl/display3D/Context3D.hx",1394,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_d75712e93d25d4a6_1395_boot,"openfl.display3D._Context3D.Context3DTelemetry_Impl_","boot",0xa804c893,"openfl.display3D._Context3D.Context3DTelemetry_Impl_.boot","openfl/display3D/Context3D.hx",1395,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_d75712e93d25d4a6_1396_boot,"openfl.display3D._Context3D.Context3DTelemetry_Impl_","boot",0xa804c893,"openfl.display3D._Context3D.Context3DTelemetry_Impl_.boot","openfl/display3D/Context3D.hx",1396,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_d75712e93d25d4a6_1397_boot,"openfl.display3D._Context3D.Context3DTelemetry_Impl_","boot",0xa804c893,"openfl.display3D._Context3D.Context3DTelemetry_Impl_.boot","openfl/display3D/Context3D.hx",1397,0xc899cbb9)
...
{
{
            	HX_STACKFRAME(&_hx_pos_d75712e93d25d4a6_1394_boot)
HXDLIN(1394)		DRAW_CALLS = (int)0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_d75712e93d25d4a6_1395_boot)
HXDLIN(1395)		COUNT_INDEX_BUFFER = (int)1;
            	}
{
            	HX_STACKFRAME(&_hx_pos_d75712e93d25d4a6_1396_boot)
HXDLIN(1396)		COUNT_VERTEX_BUFFER = (int)2;
            	}
{
            	HX_STACKFRAME(&_hx_pos_d75712e93d25d4a6_1397_boot)
HXDLIN(1397)		COUNT_TEXTURE = (int)3;
            	}
{
            	HX_STACKFRAME(&_hx_pos_d75712e93d25d4a6_1398_boot)
HXDLIN(1398)		COUNT_TEXTURE_COMPRESSED = (int)4;
            	}
{
            	HX_STACKFRAME(&_hx_pos_d75712e93d25d4a6_1399_boot)
HXDLIN(1399)		COUNT_PROGRAM = (int)5;
            	}
{
            	HX_STACKFRAME(&_hx_pos_d75712e93d25d4a6_1400_boot)
HXDLIN(1400)		MEM_INDEX_BUFFER = (int)6;
            	}
{
            	HX_STACKFRAME(&_hx_pos_d75712e93d25d4a6_1401_boot)
HXDLIN(1401)		MEM_VERTEX_BUFFER = (int)7;
            	}
{
            	HX_STACKFRAME(&_hx_pos_d75712e93d25d4a6_1402_boot)
HXDLIN(1402)		MEM_TEXTURE = (int)8;
            	}
{
            	HX_STACKFRAME(&_hx_pos_d75712e93d25d4a6_1403_boot)
HXDLIN(1403)		MEM_TEXTURE_COMPRESSED = (int)9;
            	}
{
            	HX_STACKFRAME(&_hx_pos_d75712e93d25d4a6_1404_boot)
HXDLIN(1404)		MEM_PROGRAM = (int)10;
            	}
{
            	HX_STACKFRAME(&_hx_pos_d75712e93d25d4a6_1406_boot)
HXDLIN(1406)		length = (int)11;
            	}
}
