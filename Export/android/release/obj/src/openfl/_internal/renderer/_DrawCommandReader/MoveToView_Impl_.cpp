...
HX_LOCAL_STACK_FRAME(_hx_pos_cb6bac53584ced5e_405__new,"openfl._internal.renderer._DrawCommandReader.MoveToView_Impl_","_new",0x9bdb8896,"openfl._internal.renderer._DrawCommandReader.MoveToView_Impl_._new","openfl/_internal/renderer/DrawCommandReader.hx",405,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_cb6bac53584ced5e_406_get_x,"openfl._internal.renderer._DrawCommandReader.MoveToView_Impl_","get_x",0x5989007a,"openfl._internal.renderer._DrawCommandReader.MoveToView_Impl_.get_x","openfl/_internal/renderer/DrawCommandReader.hx",406,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_cb6bac53584ced5e_407_get_y,"openfl._internal.renderer._DrawCommandReader.MoveToView_Impl_","get_y",0x5989007b,"openfl._internal.renderer._DrawCommandReader.MoveToView_Impl_.get_y","openfl/_internal/renderer/DrawCommandReader.hx",407,0xbbdbd1ae)
namespace openfl{
namespace _internal{
namespace renderer{
...
bool MoveToView_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::_internal::renderer::DrawCommandReader MoveToView_Impl__obj::_new( ::openfl::_internal::renderer::DrawCommandReader d){
            	HX_STACKFRAME(&_hx_pos_cb6bac53584ced5e_405__new)
HXDLIN( 405)		 ::openfl::_internal::renderer::DrawCommandReader this1 = d;
HXDLIN( 405)		return this1;
            	}
...
Float MoveToView_Impl__obj::get_x( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_cb6bac53584ced5e_406_get_x)
HXDLIN( 406)		return this1->buffer->f->__get(this1->fPos);
            	}
...
Float MoveToView_Impl__obj::get_y( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_cb6bac53584ced5e_407_get_y)
HXDLIN( 407)		::Array< Float > this2 = this1->buffer->f;
HXDLIN( 407)		return this2->__get((this1->fPos + (int)1));
            	}
