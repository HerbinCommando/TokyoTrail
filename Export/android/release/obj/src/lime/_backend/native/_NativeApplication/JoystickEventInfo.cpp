...
HX_DEFINE_STACK_FRAME(_hx_pos_4c8f67ddac45293c_875_new,"lime._backend.native._NativeApplication.JoystickEventInfo","new",0x2df84fa1,"lime._backend.native._NativeApplication.JoystickEventInfo.new","lime/_backend/native/NativeApplication.hx",875,0xb13849fd)
HX_LOCAL_STACK_FRAME(_hx_pos_4c8f67ddac45293c_889_clone,"lime._backend.native._NativeApplication.JoystickEventInfo","clone",0x8796a4de,"lime._backend.native._NativeApplication.JoystickEventInfo.clone","lime/_backend/native/NativeApplication.hx",889,0xb13849fd)
namespace lime{
namespace _backend{
namespace native{
...
Float y = __o_y.Default(0);
            	HX_STACKFRAME(&_hx_pos_4c8f67ddac45293c_875_new)
HXLINE( 877)		this->type = type;
HXLINE( 878)		this->id = id;
HXLINE( 879)		this->index = index;
HXLINE( 880)		this->value = value;
HXLINE( 881)		this->x = x;
HXLINE( 882)		this->y = y;
            	}
...
bool JoystickEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_backend::native::_NativeApplication::JoystickEventInfo JoystickEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_4c8f67ddac45293c_889_clone)
HXDLIN( 889)		return  ::lime::_backend::native::_NativeApplication::JoystickEventInfo_obj::__alloc( HX_CTX ,this->type,this->id,this->index,this->value,this->x,this->y);
            	}
