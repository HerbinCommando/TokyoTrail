...
HXDLIN(  30)		switch((int)(value)){
            			case (int)0: {
HXLINE(  32)				return HX_("baseline",85,dc,27,11);
            			}
            			break;
            			case (int)1: {
HXLINE(  33)				return HX_("baselineConstrained",d1,73,c8,e8);
            			}
            			break;
            			case (int)2: {
HXLINE(  34)				return HX_("baselineExtended",5e,fa,57,d8);
            			}
            			break;
            			case (int)3: {
HXLINE(  35)				return HX_("standard",3d,37,78,ea);
            			}
            			break;
            			case (int)4: {
HXLINE(  36)				return HX_("standardConstrained",19,24,99,7f);
            			}
            			break;
            			default:{
