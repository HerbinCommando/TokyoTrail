...
HXDLIN(  66)		 ::lime::_backend::native::NativeHTTPRequest _gthis = hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 113)		if (::StringTools_obj::startsWith(path,HX_("~/",f1,6d,00,00))) {
HXLINE( 115)			::String path1 = (::Sys_obj::getEnv(HX_("HOME",1f,92,d3,2f)) + HX_("/",2f,00,00,00));
HXDLIN( 115)			path = (path1 + path.substr((int)2,null()));
            		}
HXLINE( 120)		if (hx::IsNull( path )) {
HXLINE( 122)			 ::lime::app::Promise_haxe_io_Bytes _hx_tmp = this->promise;
...
HXLINE( 134)				 ::lime::app::Promise_haxe_io_Bytes _hx_tmp1 = this->promise;
...
HXDLIN( 380)			_hx_tmp = (max >= input->length);
            		}
            		else {
HXDLIN( 380)			_hx_tmp = false;
            		}
