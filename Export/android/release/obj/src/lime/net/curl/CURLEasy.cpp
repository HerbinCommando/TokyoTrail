...
HXDLIN(  22)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_curl_easy_cleanup(handle);
            	}
...
HXDLIN(  31)		return ::lime::_backend::native::NativeCFFI_obj::cffi_lime_curl_easy_duphandle(handle);
            	}
...
HXDLIN(  42)		return ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_curl_easy_escape(handle,url,length)) );
            	}
...
HXDLIN(  53)		return ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_curl_easy_getinfo(handle,info)) );
            	}
...
HXDLIN(  64)		return ::lime::_backend::native::NativeCFFI_obj::cffi_lime_curl_easy_init();
            	}
...
HXDLIN(  75)		return ::lime::_backend::native::NativeCFFI_obj::cffi_lime_curl_easy_pause(handle,bitMask);
            	}
...
HXDLIN(  86)		return ::lime::_backend::native::NativeCFFI_obj::cffi_lime_curl_easy_perform(handle);
            	}
...
HXDLIN( 108)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_curl_easy_reset(handle);
            	}
...
HXDLIN( 144)		return ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_curl_easy_strerror(code)) );
            	}
...
HXDLIN( 155)		return ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_curl_easy_unescape(handle,url,inLength,outLength)) );
            	}
...
HXLINE( 174)		return ( (int)(callback(bytes,size,nmemb)) );
            	}
