...
HX_DEFINE_STACK_FRAME(_hx_pos_15a8768f3739a6a3_9_new,"lime.graphics.opengl.ext.ARM_mali_program_binary","new",0xfa1b68d7,"lime.graphics.opengl.ext.ARM_mali_program_binary.new","lime/graphics/opengl/ext/ARM_mali_program_binary.hx",9,0xf7b2e99b)
namespace lime{
namespace graphics{
namespace opengl{
namespace ext{
...
HXDLIN(   9)		this->MALI_PROGRAM_BINARY_ARM = (int)36705;
            	}
