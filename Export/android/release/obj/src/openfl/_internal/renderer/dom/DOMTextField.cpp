...
HX_LOCAL_STACK_FRAME(_hx_pos_584059f88c62c757_28_measureText,"openfl._internal.renderer.dom.DOMTextField","measureText",0x2926ab8f,"openfl._internal.renderer.dom.DOMTextField.measureText","openfl/_internal/renderer/dom/DOMTextField.hx",28,0xc9b27f2c)
HX_LOCAL_STACK_FRAME(_hx_pos_584059f88c62c757_71_render,"openfl._internal.renderer.dom.DOMTextField","render",0xcba99572,"openfl._internal.renderer.dom.DOMTextField.render","openfl/_internal/renderer/dom/DOMTextField.hx",71,0xc9b27f2c)
HX_LOCAL_STACK_FRAME(_hx_pos_584059f88c62c757_364___getAttributeMatch,"openfl._internal.renderer.dom.DOMTextField","__getAttributeMatch",0x294ef003,"openfl._internal.renderer.dom.DOMTextField.__getAttributeMatch","openfl/_internal/renderer/dom/DOMTextField.hx",364,0xc9b27f2c)
HX_LOCAL_STACK_FRAME(_hx_pos_584059f88c62c757_22_boot,"openfl._internal.renderer.dom.DOMTextField","boot",0x0065af4e,"openfl._internal.renderer.dom.DOMTextField.boot","openfl/_internal/renderer/dom/DOMTextField.hx",22,0xc9b27f2c)
...
void DOMTextField_obj::measureText( ::openfl::text::TextField textField){
            	HX_STACKFRAME(&_hx_pos_584059f88c62c757_28_measureText)
            	}
...
void DOMTextField_obj::render( ::openfl::text::TextField textField, ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACKFRAME(&_hx_pos_584059f88c62c757_71_render)
            	}
...
::String DOMTextField_obj::_hx___getAttributeMatch( ::EReg regex){
            	HX_STACKFRAME(&_hx_pos_584059f88c62c757_364___getAttributeMatch)
HXDLIN( 364)		if (hx::IsNotNull( regex->matched((int)2) )) {
HXDLIN( 364)			return regex->matched((int)2);
            		}
            		else {
HXDLIN( 364)			return regex->matched((int)3);
            		}
...
{
{
            	HX_GC_STACKFRAME(&_hx_pos_584059f88c62c757_22_boot)
HXDLIN(  22)		_hx___regexColor =  ::EReg_obj::__alloc( HX_CTX ,HX_("color=(\"#([^\"]+)\"|'#([^']+)')",36,15,0f,76),HX_("i",69,00,00,00));
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_584059f88c62c757_23_boot)
HXDLIN(  23)		_hx___regexFace =  ::EReg_obj::__alloc( HX_CTX ,HX_("face=(\"([^\"]+)\"|'([^']+)')",1e,00,2b,89),HX_("i",69,00,00,00));
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_584059f88c62c757_24_boot)
HXDLIN(  24)		_hx___regexFont =  ::EReg_obj::__alloc( HX_CTX ,HX_("<font ([^>]+)>",eb,24,d0,0a),HX_("gi",22,5a,00,00));
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_584059f88c62c757_25_boot)
HXDLIN(  25)		_hx___regexCloseFont =  ::EReg_obj::__alloc( HX_CTX ,HX_("</font>",3c,82,5f,8e),HX_("gi",22,5a,00,00));
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_584059f88c62c757_26_boot)
HXDLIN(  26)		_hx___regexSize =  ::EReg_obj::__alloc( HX_CTX ,HX_("size=(\"([^\"]+)\"|'([^']+)')",42,27,be,87),HX_("i",69,00,00,00));
            	}
}
