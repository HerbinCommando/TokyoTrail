...
HX_DEFINE_STACK_FRAME(_hx_pos_fffaa4aaa0c483f8_19_new,"openfl._internal.timeline.Frame","new",0x1899b982,"openfl._internal.timeline.Frame.new","openfl/_internal/timeline/Frame.hx",19,0x16979fad)
namespace openfl{
namespace _internal{
namespace timeline{

void Frame_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_fffaa4aaa0c483f8_19_new)
HXDLIN(  19)		this->objects = ::Array_obj< ::Dynamic>::__new();
            	}
