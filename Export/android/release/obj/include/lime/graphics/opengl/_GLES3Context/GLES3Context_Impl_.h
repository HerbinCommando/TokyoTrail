...
class HXCPP_CLASS_ATTRIBUTES GLES3Context_Impl__obj : public hx::Object
{
	...
	public:
		...
		static void getInteger64i_v( ::lime::_backend::native::NativeGLRenderContext this1,int pname,Float params);
		...
		static int getIntegeri( ::lime::_backend::native::NativeGLRenderContext this1,int pname);
		static ::Dynamic getIntegeri_dyn();

		static void getIntegeri_v( ::lime::_backend::native::NativeGLRenderContext this1,int pname,Float params);
		...
		static void getInternalformativ( ::lime::_backend::native::NativeGLRenderContext this1,int target,int internalformat,int pname,Float params);
		...
		static int getSyncParameteri( ::lime::_backend::native::NativeGLRenderContext this1, ::lime::graphics::opengl::GLObject sync,int pname);
		static ::Dynamic getSyncParameteri_dyn();

		static void getSyncParameteriv( ::lime::_backend::native::NativeGLRenderContext this1, ::lime::graphics::opengl::GLObject sync,int pname,Float params);
		...
		static void mapBufferRange( ::lime::_backend::native::NativeGLRenderContext this1,int target,Float offset,int length,int access);
