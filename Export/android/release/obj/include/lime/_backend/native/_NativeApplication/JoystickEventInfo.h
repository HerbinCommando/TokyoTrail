...
HX_DECLARE_STACK_FRAME(_hx_pos_4c8f67ddac45293c_875_new)
...
HXLINE( 877)		( ( ::lime::_backend::native::_NativeApplication::JoystickEventInfo)(__this) )->type = type;
HXLINE( 878)		( ( ::lime::_backend::native::_NativeApplication::JoystickEventInfo)(__this) )->id = id;
HXLINE( 879)		( ( ::lime::_backend::native::_NativeApplication::JoystickEventInfo)(__this) )->index = index;
HXLINE( 880)		( ( ::lime::_backend::native::_NativeApplication::JoystickEventInfo)(__this) )->value = value;
HXLINE( 881)		( ( ::lime::_backend::native::_NativeApplication::JoystickEventInfo)(__this) )->x = x;
HXLINE( 882)		( ( ::lime::_backend::native::_NativeApplication::JoystickEventInfo)(__this) )->y = y;
            	}
