...
HX_LOCAL_STACK_FRAME(_hx_pos_39b0deb1236c4593_299_callMember,"lime.system.JNIMethod","callMember",0x1acfd846,"lime.system.JNIMethod.callMember","lime/system/JNI.hx",299,0x21970b7f)
HX_LOCAL_STACK_FRAME(_hx_pos_39b0deb1236c4593_314_callStatic,"lime.system.JNIMethod","callStatic",0x1c15d29a,"lime.system.JNIMethod.callStatic","lime/system/JNI.hx",314,0x21970b7f)
...
bool JNIMethod_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic JNIMethod_obj::callMember(::cpp::VirtualArray args){
            	HX_STACKFRAME(&_hx_pos_39b0deb1236c4593_299_callMember)
HXLINE( 302)		 ::Dynamic jobject = args->shift();
HXLINE( 303)		return ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_jni_call_member(hx::DynamicPtr(this->method),hx::DynamicPtr(jobject),hx::DynamicPtr(args))) );
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(JNIMethod_obj,callMember,return )
 ...
 ::Dynamic JNIMethod_obj::callStatic(::cpp::VirtualArray args){
            	HX_STACKFRAME(&_hx_pos_39b0deb1236c4593_314_callStatic)
HXDLIN( 314)		return ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_jni_call_static(hx::DynamicPtr(this->method),hx::DynamicPtr(args))) );
            	}
