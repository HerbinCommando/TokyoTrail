...
HX_DEFINE_STACK_FRAME(_hx_pos_21b95e0e91b0df21_31_new,"openfl._internal.renderer.dom.DOMRenderer","new",0x90a7aed0,"openfl._internal.renderer.dom.DOMRenderer.new","openfl/_internal/renderer/dom/DOMRenderer.hx",31,0xc812e2a0)
HX_LOCAL_STACK_FRAME(_hx_pos_21b95e0e91b0df21_145_render,"openfl._internal.renderer.dom.DOMRenderer","render",0x321c32e6,"openfl._internal.renderer.dom.DOMRenderer.render","openfl/_internal/renderer/dom/DOMRenderer.hx",145,0xc812e2a0)
HX_LOCAL_STACK_FRAME(_hx_pos_21b95e0e91b0df21_167_renderStage3D,"openfl._internal.renderer.dom.DOMRenderer","renderStage3D",0xc21c00a9,"openfl._internal.renderer.dom.DOMRenderer.renderStage3D","openfl/_internal/renderer/dom/DOMRenderer.hx",167,0xc812e2a0)
HX_LOCAL_STACK_FRAME(_hx_pos_21b95e0e91b0df21_71_applyStyle,"openfl._internal.renderer.dom.DOMRenderer","applyStyle",0x6484f073,"openfl._internal.renderer.dom.DOMRenderer.applyStyle","openfl/_internal/renderer/dom/DOMRenderer.hx",71,0xc812e2a0)
HX_LOCAL_STACK_FRAME(_hx_pos_21b95e0e91b0df21_176_updateClip,"openfl._internal.renderer.dom.DOMRenderer","updateClip",0x2f8d2909,"openfl._internal.renderer.dom.DOMRenderer.updateClip","openfl/_internal/renderer/dom/DOMRenderer.hx",176,0xc812e2a0)
namespace openfl{
namespace _internal{
namespace renderer{
namespace dom{
...
void DOMRenderer_obj::__construct( ::openfl::display::Stage stage, ::lime::graphics::DOMRenderContext element){
            	HX_STACKFRAME(&_hx_pos_21b95e0e91b0df21_31_new)
HXDLIN(  31)		super::__construct(stage);
            	}
...
void DOMRenderer_obj::render(){
            	HX_STACKFRAME(&_hx_pos_21b95e0e91b0df21_145_render)
HXLINE( 147)		this->renderSession->allowSmoothing = hx::IsNotEq( this->stage->quality,(int)2 );
HXLINE( 149)		if (!(this->stage->_hx___transparent)) {
HXLINE( 151)			this->element->style->__SetField(HX_("background",ee,93,1d,26),this->stage->_hx___colorString,hx::paccDynamic);
            		}
            		else {
HXLINE( 155)			this->element->style->__SetField(HX_("background",ee,93,1d,26),HX_("none",b8,12,0a,49),hx::paccDynamic);
            		}
HXLINE( 159)		this->renderSession->z = (int)1;
HXLINE( 160)		this->stage->_hx___renderDOM(this->renderSession);
            	}


void DOMRenderer_obj::renderStage3D(){
            	HX_STACKFRAME(&_hx_pos_21b95e0e91b0df21_167_renderStage3D)
HXDLIN( 167)		int _g = (int)0;
HXDLIN( 167)		 ::openfl::_Vector::ObjectVector _g1 = this->stage->stage3Ds;
HXDLIN( 167)		while((_g < _g1->get_length())){
HXDLIN( 167)			 ::openfl::display::Stage3D stage3D = _g1->get(_g).StaticCast<  ::openfl::display::Stage3D >();
HXDLIN( 167)			_g = (_g + (int)1);
HXLINE( 169)			stage3D->_hx___renderDOM(this->stage,this->renderSession);
            		}
            	}
...
void DOMRenderer_obj::applyStyle( ::openfl::display::DisplayObject displayObject, ::openfl::_internal::renderer::RenderSession renderSession,bool setTransform,bool setAlpha,bool setClip){
            	HX_STACKFRAME(&_hx_pos_21b95e0e91b0df21_71_applyStyle)
            	}
...
void DOMRenderer_obj::updateClip( ::openfl::display::DisplayObject displayObject, ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACKFRAME(&_hx_pos_21b95e0e91b0df21_176_updateClip)
HXLINE( 178)		 ::openfl::_internal::renderer::dom::DOMMaskManager maskManager = ( ( ::openfl::_internal::renderer::dom::DOMMaskManager)(renderSession->maskManager) );
HXLINE( 179)		maskManager->updateClip(displayObject);
            	}
