...
HX_DECLARE_STACK_FRAME(_hx_pos_4be9d6956d8ea946_919_new)
...
HXLINE( 921)		( ( ::lime::_backend::native::_NativeApplication::KeyEventInfo)(__this) )->type = type;
HXLINE( 922)		( ( ::lime::_backend::native::_NativeApplication::KeyEventInfo)(__this) )->windowID = windowID;
HXLINE( 923)		( ( ::lime::_backend::native::_NativeApplication::KeyEventInfo)(__this) )->keyCode = keyCode;
HXLINE( 924)		( ( ::lime::_backend::native::_NativeApplication::KeyEventInfo)(__this) )->modifier = modifier;
            	}
