...
HX_LOCAL_STACK_FRAME(_hx_pos_f172e181152f6262_21_render,"openfl._internal.renderer.dom.DOMBitmap","render",0x729dea7a,"openfl._internal.renderer.dom.DOMBitmap.render","openfl/_internal/renderer/dom/DOMBitmap.hx",21,0x32124034)
HX_LOCAL_STACK_FRAME(_hx_pos_f172e181152f6262_64_renderCanvas,"openfl._internal.renderer.dom.DOMBitmap","renderCanvas",0x22facaf2,"openfl._internal.renderer.dom.DOMBitmap.renderCanvas","openfl/_internal/renderer/dom/DOMBitmap.hx",64,0x32124034)
HX_LOCAL_STACK_FRAME(_hx_pos_f172e181152f6262_112_renderImage,"openfl._internal.renderer.dom.DOMBitmap","renderImage",0x8ed26a81,"openfl._internal.renderer.dom.DOMBitmap.renderImage","openfl/_internal/renderer/dom/DOMBitmap.hx",112,0x32124034)
namespace openfl{
namespace _internal{
namespace renderer{
namespace dom{
...
void DOMBitmap_obj::render( ::openfl::display::Bitmap bitmap, ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACKFRAME(&_hx_pos_f172e181152f6262_21_render)
            	}
...
void DOMBitmap_obj::renderCanvas( ::openfl::display::Bitmap bitmap, ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACKFRAME(&_hx_pos_f172e181152f6262_64_renderCanvas)
            	}
...
void DOMBitmap_obj::renderImage( ::openfl::display::Bitmap bitmap, ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACKFRAME(&_hx_pos_f172e181152f6262_112_renderImage)
            	}
