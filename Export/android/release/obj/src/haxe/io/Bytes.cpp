...
HX_LOCAL_STACK_FRAME(_hx_pos_7de8773c9a509473_262_setDouble,"haxe.io.Bytes","setDouble",0xa657d930,"haxe.io.Bytes.setDouble","haxe/io/Bytes.hx",262,0x68bfff33)
HX_LOCAL_STACK_FRAME(_hx_pos_7de8773c9a509473_285_setFloat,"haxe.io.Bytes","setFloat",0xdaed805d,"haxe.io.Bytes.setFloat","haxe/io/Bytes.hx",285,0x68bfff33)
HX_LOCAL_STACK_FRAME(_hx_pos_7de8773c9a509473_308_getUInt16,"haxe.io.Bytes","getUInt16",0xa94afaf2,"haxe.io.Bytes.getUInt16","haxe/io/Bytes.hx",308,0x68bfff33)
HX_LOCAL_STACK_FRAME(_hx_pos_7de8773c9a509473_315_setUInt16,"haxe.io.Bytes","setUInt16",0x8c9be6fe,"haxe.io.Bytes.setUInt16","haxe/io/Bytes.hx",315,0x68bfff33)
HX_LOCAL_STACK_FRAME(_hx_pos_7de8773c9a509473_337_getInt32,"haxe.io.Bytes","getInt32",0xe819f49b,"haxe.io.Bytes.getInt32","haxe/io/Bytes.hx",337,0x68bfff33)
HX_LOCAL_STACK_FRAME(_hx_pos_7de8773c9a509473_345_getInt64,"haxe.io.Bytes","getInt64",0xe819f73a,"haxe.io.Bytes.getInt64","haxe/io/Bytes.hx",345,0x68bfff33)
HX_LOCAL_STACK_FRAME(_hx_pos_7de8773c9a509473_351_setInt32,"haxe.io.Bytes","setInt32",0x96774e0f,"haxe.io.Bytes.setInt32","haxe/io/Bytes.hx",351,0x68bfff33)
HX_LOCAL_STACK_FRAME(_hx_pos_7de8773c9a509473_365_setInt64,"haxe.io.Bytes","setInt64",0x967750ae,"haxe.io.Bytes.setInt64","haxe/io/Bytes.hx",365,0x68bfff33)
HX_LOCAL_STACK_FRAME(_hx_pos_7de8773c9a509473_370_getString,"haxe.io.Bytes","getString",0xa16beae4,"haxe.io.Bytes.getString","haxe/io/Bytes.hx",370,0x68bfff33)
HX_LOCAL_STACK_FRAME(_hx_pos_7de8773c9a509473_430_readString,"haxe.io.Bytes","readString",0x5f58954a,"haxe.io.Bytes.readString","haxe/io/Bytes.hx",430,0x68bfff33)
HX_LOCAL_STACK_FRAME(_hx_pos_7de8773c9a509473_450_toString,"haxe.io.Bytes","toString",0x0291226f,"haxe.io.Bytes.toString","haxe/io/Bytes.hx",450,0x68bfff33)
HX_LOCAL_STACK_FRAME(_hx_pos_7de8773c9a509473_454_toHex,"haxe.io.Bytes","toHex",0x14173a7d,"haxe.io.Bytes.toHex","haxe/io/Bytes.hx",454,0x68bfff33)
HX_LOCAL_STACK_FRAME(_hx_pos_7de8773c9a509473_469_getData,"haxe.io.Bytes","getData",0xd7d05d7d,"haxe.io.Bytes.getData","haxe/io/Bytes.hx",469,0x68bfff33)
HX_LOCAL_STACK_FRAME(_hx_pos_7de8773c9a509473_472_alloc,"haxe.io.Bytes","alloc",0x2199ead2,"haxe.io.Bytes.alloc","haxe/io/Bytes.hx",472,0x68bfff33)
HX_LOCAL_STACK_FRAME(_hx_pos_7de8773c9a509473_500_ofString,"haxe.io.Bytes","ofString",0x6e53bb0b,"haxe.io.Bytes.ofString","haxe/io/Bytes.hx",500,0x68bfff33)
HX_LOCAL_STACK_FRAME(_hx_pos_7de8773c9a509473_571_ofData,"haxe.io.Bytes","ofData",0x4f3005e4,"haxe.io.Bytes.ofData","haxe/io/Bytes.hx",571,0x68bfff33)
HX_LOCAL_STACK_FRAME(_hx_pos_7de8773c9a509473_587_fastGet,"haxe.io.Bytes","fastGet",0xa10d56f7,"haxe.io.Bytes.fastGet","haxe/io/Bytes.hx",587,0x68bfff33)
namespace haxe{
namespace io{
...
void Bytes_obj::setDouble(int pos,Float v){
            	HX_STACKFRAME(&_hx_pos_7de8773c9a509473_262_setDouble)
HXLINE( 271)		bool _hx_tmp;
HXDLIN( 271)		if ((pos >= (int)0)) {
HXLINE( 271)			_hx_tmp = ((pos + (int)8) > this->length);
            		}
            		else {
HXLINE( 271)			_hx_tmp = true;
            		}
HXDLIN( 271)		if (_hx_tmp) {
HXLINE( 271)			HX_STACK_DO_THROW(::haxe::io::Error_obj::OutsideBounds_dyn());
            		}
HXLINE( 272)		::__hxcpp_memory_set_double(this->b,pos,v);
            	}
...
void Bytes_obj::setFloat(int pos,Float v){
            	HX_STACKFRAME(&_hx_pos_7de8773c9a509473_285_setFloat)
HXLINE( 294)		bool _hx_tmp;
HXDLIN( 294)		if ((pos >= (int)0)) {
HXLINE( 294)			_hx_tmp = ((pos + (int)4) > this->length);
            		}
            		else {
...
HXLINE( 295)		::__hxcpp_memory_set_float(this->b,pos,v);
            	}
...
int Bytes_obj::getUInt16(int pos){
            	HX_STACKFRAME(&_hx_pos_7de8773c9a509473_308_getUInt16)
HXDLIN( 308)		int _hx_tmp = this->b->__get(pos);
HXDLIN( 308)		::Array< unsigned char > _hx_tmp1 = this->b;
HXDLIN( 308)		return ((int)_hx_tmp | (int)((int)_hx_tmp1->__get((pos + (int)1)) << (int)(int)8));
            	}
...
void Bytes_obj::setUInt16(int pos,int v){
            	HX_STACKFRAME(&_hx_pos_7de8773c9a509473_315_setUInt16)
HXLINE( 319)		this->b[pos] = v;
HXLINE( 320)		::Array< unsigned char > _hx_tmp = this->b;
HXDLIN( 320)		_hx_tmp[(pos + (int)1)] = ((int)v >> (int)(int)8);
            	}
...
int Bytes_obj::getInt32(int pos){
            	HX_STACKFRAME(&_hx_pos_7de8773c9a509473_337_getInt32)
HXDLIN( 337)		int _hx_tmp = this->b->__get(pos);
HXDLIN( 337)		::Array< unsigned char > _hx_tmp1 = this->b;
HXDLIN( 337)		int _hx_tmp2 = ((int)_hx_tmp | (int)((int)_hx_tmp1->__get((pos + (int)1)) << (int)(int)8));
HXDLIN( 337)		::Array< unsigned char > _hx_tmp3 = this->b;
HXDLIN( 337)		int _hx_tmp4 = ((int)_hx_tmp2 | (int)((int)_hx_tmp3->__get((pos + (int)2)) << (int)(int)16));
HXDLIN( 337)		::Array< unsigned char > _hx_tmp5 = this->b;
HXDLIN( 337)		return ((int)_hx_tmp4 | (int)((int)_hx_tmp5->__get((pos + (int)3)) << (int)(int)24));
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Bytes_obj,getInt32,return )
 ...
 cpp::Int64Struct Bytes_obj::getInt64(int pos){
            	HX_STACKFRAME(&_hx_pos_7de8773c9a509473_345_getInt64)
HXDLIN( 345)		int pos1 = (pos + (int)4);
HXDLIN( 345)		int high = this->b->__get(pos1);
HXDLIN( 345)		::Array< unsigned char > high1 = this->b;
HXDLIN( 345)		int high2 = ((int)high | (int)((int)high1->__get((pos1 + (int)1)) << (int)(int)8));
HXDLIN( 345)		::Array< unsigned char > high3 = this->b;
HXDLIN( 345)		int high4 = ((int)high2 | (int)((int)high3->__get((pos1 + (int)2)) << (int)(int)16));
HXDLIN( 345)		::Array< unsigned char > high5 = this->b;
HXDLIN( 345)		int low = this->b->__get(pos);
HXDLIN( 345)		::Array< unsigned char > low1 = this->b;
HXDLIN( 345)		int low2 = ((int)low | (int)((int)low1->__get((pos + (int)1)) << (int)(int)8));
HXDLIN( 345)		::Array< unsigned char > low3 = this->b;
HXDLIN( 345)		int low4 = ((int)low2 | (int)((int)low3->__get((pos + (int)2)) << (int)(int)16));
HXDLIN( 345)		::Array< unsigned char > low5 = this->b;
HXDLIN( 345)		return _hx_int64_make(((int)high4 | (int)((int)high5->__get((pos1 + (int)3)) << (int)(int)24)),((int)low4 | (int)((int)low5->__get((pos + (int)3)) << (int)(int)24)));
            	}
...
void Bytes_obj::setInt32(int pos,int v){
            	HX_STACKFRAME(&_hx_pos_7de8773c9a509473_351_setInt32)
HXLINE( 355)		this->b[pos] = v;
HXLINE( 356)		::Array< unsigned char > _hx_tmp = this->b;
HXDLIN( 356)		_hx_tmp[(pos + (int)1)] = ((int)v >> (int)(int)8);
HXLINE( 357)		::Array< unsigned char > _hx_tmp1 = this->b;
HXDLIN( 357)		_hx_tmp1[(pos + (int)2)] = ((int)v >> (int)(int)16);
HXLINE( 358)		::Array< unsigned char > _hx_tmp2 = this->b;
HXDLIN( 358)		_hx_tmp2[(pos + (int)3)] = hx::UShr(v,(int)24);
            	}
...
void Bytes_obj::setInt64(int pos, cpp::Int64Struct v){
            	HX_STACKFRAME(&_hx_pos_7de8773c9a509473_365_setInt64)
HXLINE( 366)		{
HXLINE( 366)			int v1 = _hx_int64_low(v);
HXDLIN( 366)			this->b[pos] = v1;
HXDLIN( 366)			::Array< unsigned char > _hx_tmp = this->b;
HXDLIN( 366)			_hx_tmp[(pos + (int)1)] = ((int)v1 >> (int)(int)8);
HXDLIN( 366)			::Array< unsigned char > _hx_tmp1 = this->b;
HXDLIN( 366)			_hx_tmp1[(pos + (int)2)] = ((int)v1 >> (int)(int)16);
HXDLIN( 366)			::Array< unsigned char > _hx_tmp2 = this->b;
HXDLIN( 366)			_hx_tmp2[(pos + (int)3)] = hx::UShr(v1,(int)24);
            		}
HXLINE( 367)		{
HXLINE( 367)			int pos1 = (pos + (int)4);
HXDLIN( 367)			int v2 = _hx_int64_high(v);
HXDLIN( 367)			this->b[pos1] = v2;
HXDLIN( 367)			::Array< unsigned char > _hx_tmp3 = this->b;
HXDLIN( 367)			_hx_tmp3[(pos1 + (int)1)] = ((int)v2 >> (int)(int)8);
HXDLIN( 367)			::Array< unsigned char > _hx_tmp4 = this->b;
HXDLIN( 367)			_hx_tmp4[(pos1 + (int)2)] = ((int)v2 >> (int)(int)16);
HXDLIN( 367)			::Array< unsigned char > _hx_tmp5 = this->b;
HXDLIN( 367)			_hx_tmp5[(pos1 + (int)3)] = hx::UShr(v2,(int)24);
            		}
            	}
...
::String Bytes_obj::getString(int pos,int len){
            	HX_STACKFRAME(&_hx_pos_7de8773c9a509473_370_getString)
HXLINE( 372)		bool _hx_tmp;
HXDLIN( 372)		bool _hx_tmp1;
HXDLIN( 372)		if ((pos >= (int)0)) {
HXLINE( 372)			_hx_tmp1 = (len < (int)0);
            		}
            		else {
HXLINE( 372)			_hx_tmp1 = true;
            		}
HXDLIN( 372)		if (!(_hx_tmp1)) {
HXLINE( 372)			_hx_tmp = ((pos + len) > this->length);
            		}
            		else {
...
HXLINE( 382)		::String result = HX_("",00,00,00,00);
HXLINE( 383)		::__hxcpp_string_of_bytes(this->b,result,pos,len);
HXLINE( 384)		return result;
            	}
...
::String Bytes_obj::readString(int pos,int len){
            	HX_STACKFRAME(&_hx_pos_7de8773c9a509473_430_readString)
HXDLIN( 430)		return this->getString(pos,len);
            	}
...
::String Bytes_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_7de8773c9a509473_450_toString)
HXDLIN( 450)		return this->getString((int)0,this->length);
            	}
...
::String Bytes_obj::toHex(){
            	HX_GC_STACKFRAME(&_hx_pos_7de8773c9a509473_454_toHex)
HXLINE( 455)		 ::StringBuf s =  ::StringBuf_obj::__alloc( HX_CTX );
HXLINE( 456)		::Array< ::Dynamic> chars = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 457)		::String str = HX_("0123456789abcdef",68,7e,d5,ef);
HXLINE( 458)		{
HXLINE( 458)			int _g1 = (int)0;
HXDLIN( 458)			int _g = str.length;
HXDLIN( 458)			while((_g1 < _g)){
HXLINE( 458)				_g1 = (_g1 + (int)1);
HXDLIN( 458)				int i = (_g1 - (int)1);
HXLINE( 459)				chars->push(str.charCodeAt(i));
            			}
            		}
HXLINE( 460)		{
HXLINE( 460)			int _g11 = (int)0;
HXDLIN( 460)			int _g2 = this->length;
HXDLIN( 460)			while((_g11 < _g2)){
HXLINE( 460)				_g11 = (_g11 + (int)1);
HXDLIN( 460)				int i1 = (_g11 - (int)1);
HXLINE( 461)				int c = this->b->__get(i1);
HXLINE( 462)				{
HXLINE( 462)					int c1 = chars->__get(((int)c >> (int)(int)4));
HXDLIN( 462)					if (hx::IsNull( s->charBuf )) {
HXLINE( 462)						s->charBuf = ::Array_obj< char >::__new();
            					}
HXDLIN( 462)					s->charBuf->push(c1);
            				}
HXLINE( 463)				{
HXLINE( 463)					int c2 = chars->__get(((int)c & (int)(int)15));
HXDLIN( 463)					if (hx::IsNull( s->charBuf )) {
HXLINE( 463)						s->charBuf = ::Array_obj< char >::__new();
            					}
HXDLIN( 463)					s->charBuf->push(c2);
            				}
            			}
            		}
HXLINE( 465)		return s->toString();
            	}
...
::Array< unsigned char > Bytes_obj::getData(){
            	HX_STACKFRAME(&_hx_pos_7de8773c9a509473_469_getData)
HXDLIN( 469)		return this->b;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Bytes_obj,getData,return )
 ...
 ::haxe::io::Bytes Bytes_obj::alloc(int length){
            	HX_GC_STACKFRAME(&_hx_pos_7de8773c9a509473_472_alloc)
HXLINE( 482)		::Array< unsigned char > a = ::Array_obj< unsigned char >::__new();
HXLINE( 483)		if ((length > (int)0)) {
HXLINE( 483)			_hx_array_set_size_exact(a,length);
            		}
HXLINE( 484)		return  ::haxe::io::Bytes_obj::__alloc( HX_CTX ,length,a);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Bytes_obj,alloc,return )
 ...
 ::haxe::io::Bytes Bytes_obj::ofString(::String s){
            	HX_GC_STACKFRAME(&_hx_pos_7de8773c9a509473_500_ofString)
HXLINE( 511)		::Array< unsigned char > a = ::Array_obj< unsigned char >::__new();
HXLINE( 512)		::__hxcpp_bytes_of_string(a,s);
HXLINE( 513)		return  ::haxe::io::Bytes_obj::__alloc( HX_CTX ,a->length,a);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Bytes_obj,ofString,return )
 ...
 ::haxe::io::Bytes Bytes_obj::ofData(::Array< unsigned char > b){
            	HX_GC_STACKFRAME(&_hx_pos_7de8773c9a509473_571_ofData)
HXDLIN( 571)		return  ::haxe::io::Bytes_obj::__alloc( HX_CTX ,b->length,b);
            	}
...
int Bytes_obj::fastGet(::Array< unsigned char > b,int pos){
            	HX_STACKFRAME(&_hx_pos_7de8773c9a509473_587_fastGet)
HXDLIN( 587)		return ( (int)(_hx_array_unsafe_get(b,pos)) );
            	}
