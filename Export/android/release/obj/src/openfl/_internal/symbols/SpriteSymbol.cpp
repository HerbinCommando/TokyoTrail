...
HX_DEFINE_STACK_FRAME(_hx_pos_93fa5daca022a01e_22_new,"openfl._internal.symbols.SpriteSymbol","new",0x907606b2,"openfl._internal.symbols.SpriteSymbol.new","openfl/_internal/symbols/SpriteSymbol.hx",22,0x4ab9bb1b)
HX_LOCAL_STACK_FRAME(_hx_pos_93fa5daca022a01e_31___createObject,"openfl._internal.symbols.SpriteSymbol","__createObject",0xc7e3e8e9,"openfl._internal.symbols.SpriteSymbol.__createObject","openfl/_internal/symbols/SpriteSymbol.hx",31,0x4ab9bb1b)
namespace openfl{
namespace _internal{
namespace symbols{

void SpriteSymbol_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_93fa5daca022a01e_22_new)
HXLINE(  24)		super::__construct();
HXLINE(  26)		this->frames = ::Array_obj< ::Dynamic>::__new();
            	}
...
bool SpriteSymbol_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::display::DisplayObject SpriteSymbol_obj::_hx___createObject( ::openfl::_internal::swf::SWFLite swf){
            	HX_GC_STACKFRAME(&_hx_pos_93fa5daca022a01e_31___createObject)
HXLINE(  33)		 ::openfl::display::MovieClip movieClip = null();
HXLINE(  36)		::openfl::display::MovieClip_obj::_hx___initSWF = swf;
HXLINE(  37)		::openfl::display::MovieClip_obj::_hx___initSymbol = hx::ObjectPtr<OBJ_>(this);
HXLINE(  40)		if (hx::IsNotNull( this->className )) {
HXLINE(  42)			hx::Class symbolType = ::Type_obj::resolveClass(this->className);
HXLINE(  44)			if (hx::IsNotNull( symbolType )) {
HXLINE(  46)				movieClip = ( ( ::openfl::display::MovieClip)(::Type_obj::createInstance(symbolType,::cpp::VirtualArray_obj::__new(0))) );
            			}
            		}
HXLINE(  56)		if (hx::IsNull( movieClip )) {
HXLINE(  58)			movieClip =  ::openfl::display::MovieClip_obj::__alloc( HX_CTX );
            		}
HXLINE(  62)		return movieClip;
            	}
