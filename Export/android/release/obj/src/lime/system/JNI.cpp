...
HX_LOCAL_STACK_FRAME(_hx_pos_d83344e4dbfeb65c_193_postUICallback,"lime.system.JNI","postUICallback",0x8d567168,"lime.system.JNI.postUICallback","lime/system/JNI.hx",193,0x21970b7f)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(JNI_obj,callStatic,return )
 ...
 ::lime::_hx_system::JNIMemberField JNI_obj::createMemberField(::String className,::String memberName,::String signature){
            	HX_GC_STACKFRAME(&_hx_pos_d83344e4dbfeb65c_59_createMemberField)
HXLINE(  61)		::lime::_hx_system::JNI_obj::init();
HXLINE(  64)		return  ::lime::_hx_system::JNIMemberField_obj::__alloc( HX_CTX ,( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_jni_create_field(className,memberName,signature,false)) ));
            	}
...
bool quietFail = __o_quietFail.Default(false);
            	HX_GC_STACKFRAME(&_hx_pos_d83344e4dbfeb65c_72_createMemberMethod)
HXLINE(  74)		::lime::_hx_system::JNI_obj::init();
HXLINE(  77)		className = className.split(HX_(".",2e,00,00,00))->join(HX_("/",2f,00,00,00));
HXLINE(  78)		 ::hx::Object * handle = ::lime::_backend::native::NativeCFFI_obj::cffi_lime_jni_create_method(className,memberName,signature,false,quietFail);
HXLINE(  80)		if (hx::IsEq( handle,hx::DynamicPtr(null()) )) {
HXLINE(  82)			if (quietFail) {
HXLINE(  84)				return null();
            			}
HXLINE(  88)			HX_STACK_DO_THROW(((HX_("Could not find member function \"",c5,79,42,b4) + memberName) + HX_("\"",22,00,00,00)));
            		}
HXLINE(  92)		 ::lime::_hx_system::JNIMethod method =  ::lime::_hx_system::JNIMethod_obj::__alloc( HX_CTX ,( ( ::Dynamic)(handle) ));
HXLINE(  93)		return method->getMemberMethod(useArray);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC5(JNI_obj,createMemberMethod,return )
 ...
 ::lime::_hx_system::JNIStaticField JNI_obj::createStaticField(::String className,::String memberName,::String signature){
            	HX_GC_STACKFRAME(&_hx_pos_d83344e4dbfeb65c_101_createStaticField)
HXLINE( 103)		::lime::_hx_system::JNI_obj::init();
HXLINE( 106)		return  ::lime::_hx_system::JNIStaticField_obj::__alloc( HX_CTX ,( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_jni_create_field(className,memberName,signature,true)) ));
            	}
...
HXLINE( 119)		className = className.split(HX_(".",2e,00,00,00))->join(HX_("/",2f,00,00,00));
HXLINE( 120)		 ::hx::Object * handle = ::lime::_backend::native::NativeCFFI_obj::cffi_lime_jni_create_method(className,memberName,signature,true,quietFail);
HXLINE( 122)		if (hx::IsEq( handle,hx::DynamicPtr(null()) )) {
HXLINE( 124)			if (quietFail) {
HXLINE( 126)				return null();
            			}
HXLINE( 130)			HX_STACK_DO_THROW(((HX_("Could not find static function \"",f1,b7,fa,62) + memberName) + HX_("\"",22,00,00,00)));
            		}
HXLINE( 134)		 ::lime::_hx_system::JNIMethod method =  ::lime::_hx_system::JNIMethod_obj::__alloc( HX_CTX ,( ( ::Dynamic)(handle) ));
HXLINE( 135)		return method->getStaticMethod(useArray);
            	}
...
HXLINE( 148)		return ::lime::_backend::native::NativeCFFI_obj::cffi_lime_jni_get_env();
            	}
...
HXLINE( 163)			 ::Dynamic method = ::lime::_hx_system::CFFI_obj::load(HX_("lime",15,17,b3,47),HX_("lime_jni_init_callback",50,af,63,63),(int)1,false);
HXLINE( 164)			method(::lime::_hx_system::JNI_obj::onCallback_dyn());
            		}
            	}
...
void JNI_obj::postUICallback( ::Dynamic callback){
            	HX_STACKFRAME(&_hx_pos_d83344e4dbfeb65c_193_postUICallback)
HXDLIN( 193)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_jni_post_ui_callback(hx::DynamicPtr(callback));
            	}
