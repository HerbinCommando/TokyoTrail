...
HX_LOCAL_STACK_FRAME(_hx_pos_c497896f47a8f539_244__new,"openfl._internal.renderer._DrawCommandReader.BeginFillView_Impl_","_new",0xff2dc446,"openfl._internal.renderer._DrawCommandReader.BeginFillView_Impl_._new","openfl/_internal/renderer/DrawCommandReader.hx",244,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_c497896f47a8f539_245_get_color,"openfl._internal.renderer._DrawCommandReader.BeginFillView_Impl_","get_color",0x83ba00b5,"openfl._internal.renderer._DrawCommandReader.BeginFillView_Impl_.get_color","openfl/_internal/renderer/DrawCommandReader.hx",245,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_c497896f47a8f539_246_get_alpha,"openfl._internal.renderer._DrawCommandReader.BeginFillView_Impl_","get_alpha",0x5af436b0,"openfl._internal.renderer._DrawCommandReader.BeginFillView_Impl_.get_alpha","openfl/_internal/renderer/DrawCommandReader.hx",246,0xbbdbd1ae)
namespace openfl{
namespace _internal{
namespace renderer{
...
bool BeginFillView_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::_internal::renderer::DrawCommandReader BeginFillView_Impl__obj::_new( ::openfl::_internal::renderer::DrawCommandReader d){
            	HX_STACKFRAME(&_hx_pos_c497896f47a8f539_244__new)
HXDLIN( 244)		 ::openfl::_internal::renderer::DrawCommandReader this1 = d;
...
int BeginFillView_Impl__obj::get_color( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_c497896f47a8f539_245_get_color)
HXDLIN( 245)		return this1->buffer->i->__get(this1->iPos);
            	}
...
Float BeginFillView_Impl__obj::get_alpha( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_c497896f47a8f539_246_get_alpha)
HXDLIN( 246)		return this1->buffer->f->__get(this1->fPos);
            	}
