...
HX_LOCAL_STACK_FRAME(_hx_pos_861188b285f627bd_14_render,"openfl._internal.renderer.dom.DOMDisplayObject","render",0x02818b9e,"openfl._internal.renderer.dom.DOMDisplayObject.render","openfl/_internal/renderer/dom/DOMDisplayObject.hx",14,0xeb6cef58)
namespace openfl{
namespace _internal{
namespace renderer{
namespace dom{
...
void DOMDisplayObject_obj::render( ::openfl::display::DisplayObject displayObject, ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACKFRAME(&_hx_pos_861188b285f627bd_14_render)
            	}
