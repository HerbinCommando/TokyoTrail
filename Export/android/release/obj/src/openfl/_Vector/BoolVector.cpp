...
HXDLIN( 335)		bool _hx_tmp = this->fixed;
...
HXDLIN( 342)		if ((index >= this->_hx___array->length)) {
...
HXDLIN( 374)			_hx_tmp = (index < this->_hx___array->length);
            		}
            		else {
HXDLIN( 374)			_hx_tmp = true;
            		}
...
HXDLIN( 385)		return this->_hx___array->iterator();
            	}
...
HXDLIN( 392)		return this->_hx___array->join(sep);
            	}
...
HXDLIN( 453)			_hx_tmp = (index < this->_hx___array->length);
            		}
            		else {
...
HXDLIN( 483)		return  ::openfl::_Vector::BoolVector_obj::__alloc( HX_CTX ,null(),null(),this->_hx___array->slice(startIndex,endIndex));
            	}
...
HXDLIN( 490)		this->_hx___array->sort(f);
            	}
...
HXDLIN( 497)		return  ::openfl::_Vector::BoolVector_obj::__alloc( HX_CTX ,null(),null(),this->_hx___array->splice(pos,len));
            	}
...
HXDLIN( 504)		if (hx::IsNotNull( this->_hx___array )) {
HXDLIN( 504)			return this->_hx___array->toString();
            		}
            		else {
...
HXDLIN( 529)		return this->_hx___array->length;
            	}
