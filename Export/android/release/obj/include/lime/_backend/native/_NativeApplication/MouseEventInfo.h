...
HX_DECLARE_STACK_FRAME(_hx_pos_e3566ee739d748b6_960_new)
...
HXLINE( 962)		( ( ::lime::_backend::native::_NativeApplication::MouseEventInfo)(__this) )->type = type;
HXLINE( 963)		( ( ::lime::_backend::native::_NativeApplication::MouseEventInfo)(__this) )->windowID = (int)0;
HXLINE( 964)		( ( ::lime::_backend::native::_NativeApplication::MouseEventInfo)(__this) )->x = x;
HXLINE( 965)		( ( ::lime::_backend::native::_NativeApplication::MouseEventInfo)(__this) )->y = y;
HXLINE( 966)		( ( ::lime::_backend::native::_NativeApplication::MouseEventInfo)(__this) )->button = button;
HXLINE( 967)		( ( ::lime::_backend::native::_NativeApplication::MouseEventInfo)(__this) )->movementX = movementX;
HXLINE( 968)		( ( ::lime::_backend::native::_NativeApplication::MouseEventInfo)(__this) )->movementY = movementY;
            	}
