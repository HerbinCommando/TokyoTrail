...
HX_LOCAL_STACK_FRAME(_hx_pos_6ecdd980159839d3_26_setShader,"openfl._internal.renderer.AbstractShaderManager","setShader",0x9aac0c64,"openfl._internal.renderer.AbstractShaderManager.setShader","openfl/_internal/renderer/AbstractShaderManager.hx",26,0x593d46f2)
namespace openfl{
namespace _internal{
namespace renderer{
...
void AbstractShaderManager_obj::setShader( ::openfl::display::Shader shader){
            	HX_STACKFRAME(&_hx_pos_6ecdd980159839d3_26_setShader)
            	}
