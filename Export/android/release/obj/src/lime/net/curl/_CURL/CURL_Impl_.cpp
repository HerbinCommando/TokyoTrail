...
HXDLIN(  23)		return ::lime::_backend::native::NativeCFFI_obj::cffi_lime_curl_getdate(date,now);
            	}
...
HXDLIN(  34)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_curl_global_cleanup();
            	}
...
HXDLIN(  43)		return ::lime::_backend::native::NativeCFFI_obj::cffi_lime_curl_global_init(flags);
            	}
...
HXDLIN(  54)		return ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_curl_version()) );
            	}
...
HXDLIN(  65)		return ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_curl_version_info(type)) );
            	}
