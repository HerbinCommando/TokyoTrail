...
HX_DEFINE_STACK_FRAME(_hx_pos_516576a6efa98cd2_31_new,"lime.app._Event_Int_Float_Void","new",0x70f46217,"lime.app._Event_Int_Float_Void.new","lime/app/Event.hx",31,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_516576a6efa98cd2_43_add,"lime.app._Event_Int_Float_Void","add",0x70ea83d8,"lime.app._Event_Int_Float_Void.add","lime/app/Event.hx",43,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_516576a6efa98cd2_221_cancel,"lime.app._Event_Int_Float_Void","cancel",0xbc7a0823,"lime.app._Event_Int_Float_Void.cancel","lime/app/Event.hx",221,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_516576a6efa98cd2_257_has,"lime.app._Event_Int_Float_Void","has",0x70efd111,"lime.app._Event_Int_Float_Void.has","lime/app/Event.hx",257,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_516576a6efa98cd2_272_remove,"lime.app._Event_Int_Float_Void","remove",0x08ceb6ed,"lime.app._Event_Int_Float_Void.remove","lime/app/Event.hx",272,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_8e4a8b866c35ec4e_91_dispatch,"lime.app._Event_Int_Float_Void","dispatch",0x5464a5a3,"lime.app._Event_Int_Float_Void.dispatch","lime/_macros/EventMacro.hx",91,0x8c7af009)
namespace lime{
namespace app{

void _Event_Int_Float_Void_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_516576a6efa98cd2_31_new)
...
int priority = __o_priority.Default(0);
            	HX_STACKFRAME(&_hx_pos_516576a6efa98cd2_43_add)
HXLINE(  46)		{
...
void _Event_Int_Float_Void_obj::cancel(){
            	HX_STACKFRAME(&_hx_pos_516576a6efa98cd2_221_cancel)
...
bool _Event_Int_Float_Void_obj::has( ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_516576a6efa98cd2_257_has)
HXLINE( 260)		{
...
void _Event_Int_Float_Void_obj::remove( ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_516576a6efa98cd2_272_remove)
...
void _Event_Int_Float_Void_obj::dispatch(int a,Float a1){
            	HX_STACKFRAME(&_hx_pos_8e4a8b866c35ec4e_91_dispatch)
