...
HXDLIN( 847)		if (!(this->_hx___transformDirty)) {
...
HXDLIN( 868)		int _g = (int)0;
HXDLIN( 868)		::Array< ::Dynamic> _g1 = this->_hx___children;
HXDLIN( 868)		while((_g < _g1->length)){
HXDLIN( 868)			 ::openfl::display::DisplayObject child = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
...
HXDLIN( 916)		return this->_hx___children->length;
            	}
