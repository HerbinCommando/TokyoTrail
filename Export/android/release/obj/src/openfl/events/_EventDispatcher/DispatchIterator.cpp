...
HX_DEFINE_STACK_FRAME(_hx_pos_eed9e911a94343be_275_new,"openfl.events._EventDispatcher.DispatchIterator","new",0x76c2678f,"openfl.events._EventDispatcher.DispatchIterator.new","openfl/events/EventDispatcher.hx",275,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_285_copy,"openfl.events._EventDispatcher.DispatchIterator","copy",0x6c1a6da6,"openfl.events._EventDispatcher.DispatchIterator.copy","openfl/events/EventDispatcher.hx",285,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_297_hasNext,"openfl.events._EventDispatcher.DispatchIterator","hasNext",0xef22001c,"openfl.events._EventDispatcher.DispatchIterator.hasNext","openfl/events/EventDispatcher.hx",297,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_313_next,"openfl.events._EventDispatcher.DispatchIterator","next",0x735836e4,"openfl.events._EventDispatcher.DispatchIterator.next","openfl/events/EventDispatcher.hx",313,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_320_remove,"openfl.events._EventDispatcher.DispatchIterator","remove",0xb5236c75,"openfl.events._EventDispatcher.DispatchIterator.remove","openfl/events/EventDispatcher.hx",320,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_350_reset,"openfl.events._EventDispatcher.DispatchIterator","reset",0xc76e4abe,"openfl.events._EventDispatcher.DispatchIterator.reset","openfl/events/EventDispatcher.hx",350,0xe2270714)
namespace openfl{
namespace events{
namespace _EventDispatcher{

void DispatchIterator_obj::__construct(::Array< ::Dynamic> list){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_275_new)
HXLINE( 277)		this->list = list;
HXLINE( 278)		this->index = list->length;
            	}
...
void DispatchIterator_obj::copy(){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_285_copy)
HXDLIN( 285)		bool _hx_tmp;
HXDLIN( 285)		if ((this->index < this->list->length)) {
HXDLIN( 285)			_hx_tmp = !(this->isCopy);
            		}
            		else {
HXDLIN( 285)			_hx_tmp = false;
            		}
HXDLIN( 285)		if (_hx_tmp) {
HXLINE( 287)			this->list = this->list->copy();
HXLINE( 288)			this->isCopy = true;
            		}
            	}
...
bool DispatchIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_297_hasNext)
HXDLIN( 297)		if ((this->index < this->list->length)) {
HXLINE( 299)			return true;
            		}
            		else {
HXLINE( 303)			this->active = false;
...
HX_DEFINE_DYNAMIC_FUNC0(DispatchIterator_obj,hasNext,return )
 ...
 ::openfl::events::_EventDispatcher::Listener DispatchIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_313_next)
HXDLIN( 313)		::Array< ::Dynamic> _hx_tmp = this->list;
HXDLIN( 313)		return _hx_tmp->__get(this->index++).StaticCast<  ::openfl::events::_EventDispatcher::Listener >();
            	}
...
void DispatchIterator_obj::remove( ::openfl::events::_EventDispatcher::Listener listener,int listIndex){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_320_remove)
HXDLIN( 320)		if (this->active) {
HXLINE( 322)			if (!(this->isCopy)) {
HXLINE( 324)				if ((listIndex < this->index)) {
HXLINE( 326)					this->index--;
            				}
            			}
            			else {
HXLINE( 332)				int _g1 = this->index;
HXDLIN( 332)				int _g = this->list->length;
HXDLIN( 332)				while((_g1 < _g)){
HXLINE( 332)					_g1 = (_g1 + (int)1);
HXDLIN( 332)					int i = (_g1 - (int)1);
HXLINE( 334)					if (hx::IsEq( this->list->__get(i).StaticCast<  ::openfl::events::_EventDispatcher::Listener >(),listener )) {
HXLINE( 336)						this->list->removeRange(i,(int)1);
...
void DispatchIterator_obj::reset(::Array< ::Dynamic> list){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_350_reset)
HXLINE( 352)		this->list = list;
HXLINE( 354)		this->active = true;
HXLINE( 355)		this->index = (int)0;
            	}
