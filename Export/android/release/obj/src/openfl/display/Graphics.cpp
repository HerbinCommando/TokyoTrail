...
HXDLIN( 581)		this->_hx___commands->endFill();
            	}
...
HXDLIN( 588)		 ::openfl::_internal::renderer::DrawCommandBuffer _hx_tmp = this->_hx___commands;
HXDLIN( 588)		 ::openfl::geom::Matrix _hx_tmp1;
HXDLIN( 588)		if (hx::IsNotNull( matrix )) {
HXDLIN( 588)			_hx_tmp1 = matrix->clone();
            		}
            		else {
HXDLIN( 588)			_hx_tmp1 = null();
            		}
...
HXDLIN( 595)		this->_hx___commands->lineGradientStyle(type,colors,alphas,ratios,matrix,spreadMethod,interpolationMethod,focalPointRatio);
            	}
