...
HXDLIN( 104)			_hx_tmp6 = (this->redMultiplier == ct->redMultiplier);
            		}
            		else {
HXDLIN( 104)			_hx_tmp6 = false;
            		}
HXDLIN( 104)		if (_hx_tmp6) {
HXDLIN( 104)			_hx_tmp5 = (this->greenMultiplier == ct->greenMultiplier);
            		}
            		else {
HXDLIN( 104)			_hx_tmp5 = false;
            		}
HXDLIN( 104)		if (_hx_tmp5) {
HXDLIN( 104)			_hx_tmp4 = (this->blueMultiplier == ct->blueMultiplier);
            		}
            		else {
HXDLIN( 104)			_hx_tmp4 = false;
            		}
HXDLIN( 104)		if (_hx_tmp4) {
HXDLIN( 104)			if (!(skipAlphaMultiplier)) {
HXDLIN( 104)				_hx_tmp3 = (this->alphaMultiplier == ct->alphaMultiplier);
            			}
            			else {
HXDLIN( 104)				_hx_tmp3 = true;
            			}
            		}
            		else {
HXDLIN( 104)			_hx_tmp3 = false;
            		}
HXDLIN( 104)		if (_hx_tmp3) {
HXDLIN( 104)			_hx_tmp2 = (this->redOffset == ct->redOffset);
            		}
            		else {
HXDLIN( 104)			_hx_tmp2 = false;
            		}
HXDLIN( 104)		if (_hx_tmp2) {
HXDLIN( 104)			_hx_tmp1 = (this->greenOffset == ct->greenOffset);
            		}
            		else {
HXDLIN( 104)			_hx_tmp1 = false;
            		}
HXDLIN( 104)		if (_hx_tmp1) {
HXDLIN( 104)			_hx_tmp = (this->blueOffset == ct->blueOffset);
            		}
            		else {
HXDLIN( 104)			_hx_tmp = false;
            		}
HXDLIN( 104)		if (_hx_tmp) {
HXDLIN( 104)			return (this->alphaOffset == ct->alphaOffset);
            		}
            		else {
...
HXDLIN( 111)			_hx_tmp5 = (this->greenMultiplier == (int)1);
            		}
            		else {
HXDLIN( 111)			_hx_tmp5 = false;
            		}
HXDLIN( 111)		if (_hx_tmp5) {
HXDLIN( 111)			_hx_tmp4 = (this->blueMultiplier == (int)1);
            		}
            		else {
HXDLIN( 111)			_hx_tmp4 = false;
            		}
HXDLIN( 111)		if (_hx_tmp4) {
HXDLIN( 111)			_hx_tmp3 = (this->alphaMultiplier == (int)1);
            		}
            		else {
HXDLIN( 111)			_hx_tmp3 = false;
            		}
HXDLIN( 111)		if (_hx_tmp3) {
HXDLIN( 111)			_hx_tmp2 = (this->redOffset == (int)0);
            		}
            		else {
HXDLIN( 111)			_hx_tmp2 = false;
            		}
HXDLIN( 111)		if (_hx_tmp2) {
HXDLIN( 111)			_hx_tmp1 = (this->greenOffset == (int)0);
            		}
            		else {
HXDLIN( 111)			_hx_tmp1 = false;
            		}
HXDLIN( 111)		if (_hx_tmp1) {
HXDLIN( 111)			_hx_tmp = (this->blueOffset == (int)0);
            		}
            		else {
HXDLIN( 111)			_hx_tmp = false;
            		}
HXDLIN( 111)		if (_hx_tmp) {
HXDLIN( 111)			return (this->alphaOffset == (int)0);
            		}
            		else {
...
HXDLIN( 125)		int _hx_tmp = ((int)::Std_obj::_hx_int(this->redOffset) << (int)(int)16);
