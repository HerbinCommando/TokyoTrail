...
HX_DEFINE_STACK_FRAME(_hx_pos_e3566ee739d748b6_960_new,"lime._backend.native._NativeApplication.MouseEventInfo","new",0x1e4161f2,"lime._backend.native._NativeApplication.MouseEventInfo.new","lime/_backend/native/NativeApplication.hx",960,0xb13849fd)
HX_LOCAL_STACK_FRAME(_hx_pos_e3566ee739d748b6_975_clone,"lime._backend.native._NativeApplication.MouseEventInfo","clone",0xea05ad6f,"lime._backend.native._NativeApplication.MouseEventInfo.clone","lime/_backend/native/NativeApplication.hx",975,0xb13849fd)
namespace lime{
namespace _backend{
namespace native{
...
Float movementY = __o_movementY.Default(0);
            	HX_STACKFRAME(&_hx_pos_e3566ee739d748b6_960_new)
HXLINE( 962)		this->type = type;
HXLINE( 963)		this->windowID = (int)0;
HXLINE( 964)		this->x = x;
HXLINE( 965)		this->y = y;
HXLINE( 966)		this->button = button;
HXLINE( 967)		this->movementX = movementX;
HXLINE( 968)		this->movementY = movementY;
            	}
...
bool MouseEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_backend::native::_NativeApplication::MouseEventInfo MouseEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_e3566ee739d748b6_975_clone)
HXDLIN( 975)		return  ::lime::_backend::native::_NativeApplication::MouseEventInfo_obj::__alloc( HX_CTX ,this->type,this->windowID,this->x,this->y,this->button,this->movementX,this->movementY);
            	}
