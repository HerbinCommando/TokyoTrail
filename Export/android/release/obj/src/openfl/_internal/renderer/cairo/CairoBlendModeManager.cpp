...
HXLINE(  81)			this->renderSession->cairo->set_operator((int)2);
HXDLIN(  81)			goto _hx_goto_1;
            		}
            		if (  (_hx_switch_0==(int)11) ){
HXLINE(  85)			this->renderSession->cairo->set_operator((int)16);
HXDLIN(  85)			goto _hx_goto_1;
            		}
            		if (  (_hx_switch_0==(int)12) ){
HXLINE(  89)			this->renderSession->cairo->set_operator((int)15);
...
HXLINE(  95)			goto _hx_goto_1;
            		...
            		/* default */{
HXLINE( 101)			this->renderSession->cairo->set_operator((int)2);
            		}
            		_hx_goto_1:;
            	}
