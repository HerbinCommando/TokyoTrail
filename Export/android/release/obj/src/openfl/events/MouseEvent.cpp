...
HX_DEFINE_STACK_FRAME(_hx_pos_93a9f8214e96e0e7_48_new,"openfl.events.MouseEvent","new",0x5c6da59e,"openfl.events.MouseEvent.new","openfl/events/MouseEvent.hx",48,0xd3783172)
HX_LOCAL_STACK_FRAME(_hx_pos_93a9f8214e96e0e7_96_clone,"openfl.events.MouseEvent","clone",0x3e8b341b,"openfl.events.MouseEvent.clone","openfl/events/MouseEvent.hx",96,0xd3783172)
HX_LOCAL_STACK_FRAME(_hx_pos_93a9f8214e96e0e7_109_toString,"openfl.events.MouseEvent","toString",0x2fb13aae,"openfl.events.MouseEvent.toString","openfl/events/MouseEvent.hx",109,0xd3783172)
...
HX_LOCAL_STACK_FRAME(_hx_pos_93a9f8214e96e0e7_114_updateAfterEvent,"openfl.events.MouseEvent","updateAfterEvent",0xc76737c9,"openfl.events.MouseEvent.updateAfterEvent","openfl/events/MouseEvent.hx",114,0xd3783172)
HX_LOCAL_STACK_FRAME(_hx_pos_93a9f8214e96e0e7_70___create,"openfl.events.MouseEvent","__create",0x1b813c1e,"openfl.events.MouseEvent.__create","openfl/events/MouseEvent.hx",70,0xd3783172)
...
int clickCount = __o_clickCount.Default(0);
            	HX_STACKFRAME(&_hx_pos_93a9f8214e96e0e7_48_new)
HXLINE(  50)		super::__construct(type,bubbles,cancelable);
HXLINE(  52)		this->shiftKey = shiftKey;
HXLINE(  53)		this->altKey = altKey;
HXLINE(  54)		this->ctrlKey = ctrlKey;
HXLINE(  55)		this->bubbles = bubbles;
HXLINE(  56)		this->relatedObject = relatedObject;
HXLINE(  57)		this->delta = delta;
HXLINE(  58)		this->localX = localX;
HXLINE(  59)		this->localY = localY;
HXLINE(  60)		this->buttonDown = buttonDown;
HXLINE(  61)		this->commandKey = commandKey;
HXLINE(  62)		this->clickCount = clickCount;
HXLINE(  64)		this->stageX = ::Math_obj::NaN;
HXLINE(  65)		this->stageY = ::Math_obj::NaN;
            	}
...
bool MouseEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event MouseEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_93a9f8214e96e0e7_96_clone)
HXLINE(  98)		 ::openfl::events::MouseEvent event =  ::openfl::events::MouseEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->localX,this->localY,this->relatedObject,this->ctrlKey,this->altKey,this->shiftKey,this->buttonDown,this->delta,this->commandKey,this->clickCount);
...
::String MouseEvent_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_93a9f8214e96e0e7_109_toString)
HXDLIN( 109)		return this->_hx___formatToString(HX_("MouseEvent",d5,bf,42,8a),::Array_obj< ::String >::fromData( _hx_array_data_094f3eac_3,11));
            	}


void MouseEvent_obj::updateAfterEvent(){
            	HX_STACKFRAME(&_hx_pos_93a9f8214e96e0e7_114_updateAfterEvent)
            	}
...
int delta = __o_delta.Default(0);
            	HX_GC_STACKFRAME(&_hx_pos_93a9f8214e96e0e7_70___create)
HXLINE(  72)		::String _hx_switch_0 = type;
            		if (  (_hx_switch_0==HX_("mouseDown",27,b1,c2,ee)) ){
HXLINE(  76)			::openfl::events::MouseEvent_obj::_hx___buttonDown = true;
HXDLIN(  76)			goto _hx_goto_5;
            		}
            		if (  (_hx_switch_0==HX_("mouseUp",e0,f3,72,c0)) ){
HXLINE(  80)			::openfl::events::MouseEvent_obj::_hx___buttonDown = false;
HXDLIN(  80)			goto _hx_goto_5;
            		}
            		/* default */{
            		}
            		_hx_goto_5:;
HXLINE(  86)		 ::openfl::events::MouseEvent event =  ::openfl::events::MouseEvent_obj::__alloc( HX_CTX ,type,true,false,local->x,local->y,null(),::openfl::events::MouseEvent_obj::_hx___ctrlKey,::openfl::events::MouseEvent_obj::_hx___altKey,::openfl::events::MouseEvent_obj::_hx___shiftKey,::openfl::events::MouseEvent_obj::_hx___buttonDown,delta,::openfl::events::MouseEvent_obj::_hx___commandKey,null());
HXLINE(  87)		event->stageX = stageX;
HXLINE(  88)		event->stageY = stageY;
HXLINE(  89)		event->target = target;
HXLINE(  91)		return event;
            	}
