...
HX_DECLARE_STACK_FRAME(_hx_pos_cc1242aa9b04079d_797_new)
...
HXLINE( 799)		( ( ::lime::_backend::native::_NativeApplication::DropEventInfo)(__this) )->type = type;
HXLINE( 800)		( ( ::lime::_backend::native::_NativeApplication::DropEventInfo)(__this) )->file = file;
            	}
